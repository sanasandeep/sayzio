...
const items = [
  ...
  { icon: Bot, name: "The full AI Suite", description: "Unlock Chat Widgets, AI Agents, the AI Widget and AI Voice Assistant — they answer, qualify and book for you 24/7." },
