    ...
    <div className="w-screen h-screen overflow-hidden relative bg-[#0a0a14] text-slate-100 font-body">
      ...
      <div className="relative h-full w-full px-[7vw] pt-[11vh] pb-[8vh] flex flex-col">
        <div className="flex-1 flex flex-col justify-center max-w-[80vw]">
          ...
          <h1 className="mt-[3vh] font-display text-[7.5vw] font-bold tracking-tight leading-[0.92]">Sayzio.<span className="block bg-gradient-to-r from-blue-300 via-fuchsia-300 to-pink-200 bg-clip-text text-transparent">For investor.</span><span className="block text-slate-200">One platform.</span></h1>
