    ...
    <div className="w-screen h-screen overflow-hidden relative bg-[#0a0a14] text-slate-100 font-body">
      ...
      <div className="relative h-full w-full px-[7vw] pt-[11vh] pb-[8vh] flex flex-col">
        ...
        <div className="mt-[4vh] grid grid-cols-2 gap-[1.5vw]">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-[1.5vw] flex items-start gap-[1.2vw]">
            <div className="font-display text-[1.6vw] font-bold text-blue-300 w-[3vw]">02</div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-[1.5vw] flex items-start gap-[1.2vw]">
            <div className="font-display text-[1.6vw] font-bold text-blue-300 w-[3vw]">03</div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-[1.5vw] flex items-start gap-[1.2vw]">
            <div className="font-display text-[1.6vw] font-bold text-blue-300 w-[3vw]">04</div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-[1.5vw] flex items-start gap-[1.2vw]">
            <div className="font-display text-[1.6vw] font-bold text-blue-300 w-[3vw]">05</div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-[1.5vw] flex items-start gap-[1.2vw]">
            <div className="font-display text-[1.6vw] font-bold text-blue-300 w-[3vw]">06</div>
      ...
      <div className="absolute bottom-[3vh] left-[5vw] right-[5vw] flex items-center justify-between text-[0.9vw] text-slate-500 z-10"><span>1inme.com</span><span>2 / 189</span></div>
    </div>
  );
}
