...
export default function Slide172Roadmapbio() {
  return (
      ...
      <div className="relative h-full w-full px-[7vw] pt-[11vh] pb-[8vh] flex flex-col">
        ...
        <div className="mt-[4vh] grid grid-cols-3 gap-[1.5vw] flex-1">
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-[1.6vw] flex flex-col">
            ...
            <div className="mt-[0.5vh] font-display text-[1.8vw] font-semibold">Editor v3</div>
            <ul className="mt-[2vh] space-y-[0.8vh] text-[1.05vw] text-slate-300 leading-snug"><li>&middot; AB testing on blocks</li><li>&middot; Block library refresh</li><li>&middot; Faster live preview</li></ul>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-[1.6vw] flex flex-col">
            <div className="text-[0.95vw] uppercase tracking-[0.3em] text-fuchsia-200">Next</div>
            <div className="mt-[0.5vh] font-display text-[1.8vw] font-semibold">Smart routing v3</div>
            <ul className="mt-[2vh] space-y-[0.8vh] text-[1.05vw] text-slate-300 leading-snug"><li>&middot; Visual rule editor</li><li>&middot; Per-rule analytics</li><li>&middot; ML-suggested rules</li></ul>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-[1.6vw] flex flex-col">
            <div className="text-[0.95vw] uppercase tracking-[0.3em] text-fuchsia-200">Later</div>
            <div className="mt-[0.5vh] font-display text-[1.8vw] font-semibold">Programmable bios</div>
            <ul className="mt-[2vh] space-y-[0.8vh] text-[1.05vw] text-slate-300 leading-snug"><li>&middot; Composable blocks</li><li>&middot; Marketplace for blocks</li><li>&middot; Bio API</li></ul>
          </div>
        </div>
      </div>
      <div className="absolute bottom-[3vh] left-[5vw] right-[5vw] flex items-center justify-between text-[0.9vw] text-slate-500 z-10"><span>1inme.com</span><span>173 / 189</span></div>
    </div>
  );
}
