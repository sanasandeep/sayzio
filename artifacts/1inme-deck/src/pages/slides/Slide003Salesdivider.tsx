...
export default function Slide003Salesdivider() {
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-[#14091f] text-slate-100 font-body">
      ...
      <div className="relative h-full w-full px-[7vw] pt-[11vh] pb-[8vh] flex flex-col">
        <div className="flex-1 flex flex-col justify-center">
          <span className="font-display text-[1.1vw] uppercase tracking-[0.5em] text-fuchsia-200">Section 01</span>
          <h2 className="mt-[2vh] font-display text-[7vw] font-bold leading-[0.94] tracking-tight max-w-[80vw]">Appendix · Sales presentation.</h2>
          <p className="mt-[3vh] text-[1.7vw] text-slate-200 max-w-[60vw] leading-snug">Twenty slides to take a buyer from problem to next step.</p>
          <div className="mt-[5vh] inline-flex items-center gap-[1.5vw]">
            ...
            <span className="text-[1vw] uppercase tracking-[0.3em] text-slate-300">Slides 3 – 23</span>
          </div>
        </div>
      </div>
      <div className="absolute bottom-[3vh] left-[5vw] right-[5vw] flex items-center justify-between text-[0.9vw] text-slate-500 z-10"><span>1inme.com</span><span>3 / 189</span></div>
    </div>
  );
}
