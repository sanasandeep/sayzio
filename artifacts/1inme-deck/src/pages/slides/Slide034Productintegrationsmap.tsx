  ...
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-[#0a0a14] text-slate-100 font-body">
      ...
      <div className="relative h-full w-full px-[7vw] pt-[11vh] pb-[8vh] flex flex-col">
        ...
        <p className="mt-[2vh] text-[1.3vw] text-slate-300 max-w-[65vw]">1INME plugs into the tools you already use.</p>
      ...
      <div className="absolute bottom-[3vh] left-[5vw] right-[5vw] flex items-center justify-between text-[0.9vw] text-slate-500 z-10"><span>1inme.com</span><span>34 / 188</span></div>
    </div>
  );
}
