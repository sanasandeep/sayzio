...
export default function Slide042Productanalyticsmodule() {
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-[#0a0a14] text-slate-100 font-body">
      ...
      <div className="relative h-full w-full px-[7vw] pt-[11vh] pb-[8vh] flex flex-col">
        <div className="grid grid-cols-12 gap-[2.5vw] flex-1">
          <div className="col-span-5 flex flex-col justify-center">
            <h2 className="font-display text-[3.2vw] font-bold leading-[1.04] tracking-tight">Analytics &amp; insights.</h2>
            <p className="mt-[2vh] text-[1.25vw] text-slate-300 max-w-[26vw]">From impression to outcome, across every module.</p>
            <ul className="mt-[3vh] space-y-[1vh] text-[1.05vw] text-slate-300"><li className="flex gap-[0.6vw]"><span className="text-fuchsia-300">&bull;</span><span>Funnel and audience views</span></li><li className="flex gap-[0.6vw]"><span className="text-fuchsia-300">&bull;</span><span>Workspace and brand splits</span></li><li className="flex gap-[0.6vw]"><span className="text-fuchsia-300">&bull;</span><span>Exports + alerts</span></li></ul>
          </div>
          <div className="col-span-7 rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.06] to-white/[0.02] p-[1.6vw] flex flex-col">
            ...
            <div className="rounded-lg border border-white/10 bg-white/[0.03] px-[1vw] py-[0.8vh] flex items-center justify-between"><span className="text-[1vw] text-slate-200">Bio views</span><span className="text-[0.9vw] text-fuchsia-200 font-mono">84,210</span></div>
            ...
            <div className="rounded-lg border border-white/10 bg-white/[0.03] px-[1vw] py-[0.8vh] flex items-center justify-between"><span className="text-[1vw] text-slate-200">Form submits</span><span className="text-[0.9vw] text-fuchsia-200 font-mono">612</span></div>
      ...
      <div className="absolute bottom-[3vh] left-[5vw] right-[5vw] flex items-center justify-between text-[0.9vw] text-slate-500 z-10"><span>1inme.com</span><span>43 / 189</span></div>
    </div>
  );
}
