...
export default function Slide129Coachesexpertsfitnesstrainer() {
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-[#0a0a14] text-slate-100 font-body">
      ...
      <div className="relative h-full w-full px-[7vw] pt-[11vh] pb-[8vh] flex flex-col">
        <h2 className="font-display text-[3.4vw] font-bold leading-[1.04] tracking-tight max-w-[65vw]">The Sayzio stack for a fitness trainers.</h2>
        ...
        <div className="mt-[4vh] grid grid-cols-5 gap-[1.4vw] flex-1 content-start">
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-[1.6vw] flex flex-col">
            ...
            <div className="font-display text-[1.5vw] font-semibold mt-[0.5vh]">Calendar (sessions)</div>
            
            
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-[1.6vw] flex flex-col">
            <div className="text-[0.85vw] uppercase tracking-[0.25em] text-fuchsia-200">Module</div>
            <div className="font-display text-[1.5vw] font-semibold mt-[0.5vh]">Vault (plans)</div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-[1.6vw] flex flex-col">
            <div className="text-[0.85vw] uppercase tracking-[0.25em] text-fuchsia-200">Module</div>
            <div className="font-display text-[1.5vw] font-semibold mt-[0.5vh]">Smart Dialer (check-ins)</div>
      ...
      <div className="absolute bottom-[3vh] left-[5vw] right-[5vw] flex items-center justify-between text-[0.9vw] text-slate-500 z-10"><span>1inme.com</span><span>130 / 189</span></div>
    </div>
  );
}
