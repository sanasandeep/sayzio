...
export default function Slide036Productbiomodule() {
  return (
        ...
        <div className="grid grid-cols-12 gap-[2.5vw] flex-1">
          ...
          <div className="col-span-7 rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.06] to-white/[0.02] p-[1.6vw] flex flex-col">
            <div className="flex items-center gap-[0.5vw] pb-[1vh] border-b border-white/10">
              ...
              <span className="ml-[1vw] text-[0.9vw] text-slate-400 font-mono">yourhandle · bio editor</span>
            </div>
            <div className="mt-[1.5vh] flex flex-col gap-[0.7vh]">
            <div className="rounded-lg border border-white/10 bg-white/[0.03] px-[1vw] py-[0.8vh] flex items-center justify-between"><span className="text-[1vw] text-slate-200">Hero block</span><span className="text-[0.9vw] text-fuchsia-200 font-mono">image + headline</span></div>
            <div className="rounded-lg border border-white/10 bg-white/[0.03] px-[1vw] py-[0.8vh] flex items-center justify-between"><span className="text-[1vw] text-slate-200">Links</span><span className="text-[0.9vw] text-fuchsia-200 font-mono">8 · sortable</span></div>
            <div className="rounded-lg border border-white/10 bg-white/[0.03] px-[1vw] py-[0.8vh] flex items-center justify-between"><span className="text-[1vw] text-slate-200">Form block</span><span className="text-[0.9vw] text-fuchsia-200 font-mono">lead capture</span></div>
            <div className="rounded-lg border border-white/10 bg-white/[0.03] px-[1vw] py-[0.8vh] flex items-center justify-between"><span className="text-[1vw] text-slate-200">Theme</span><span className="text-[0.9vw] text-fuchsia-200 font-mono">Studio · custom font</span></div>
            </div>
            
          </div>
        </div>
      </div>
      <div className="absolute bottom-[3vh] left-[5vw] right-[5vw] flex items-center justify-between text-[0.9vw] text-slate-500 z-10"><span>1inme.com</span><span>37 / 189</span></div>
    </div>
  );
}
