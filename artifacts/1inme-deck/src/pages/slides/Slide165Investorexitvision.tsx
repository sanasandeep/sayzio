...
export default function Slide165Investorexitvision() {
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-[#0a0a14] text-slate-100 font-body">
      ...
      <div className="relative h-full w-full px-[7vw] pt-[11vh] pb-[8vh] flex flex-col">
        <h2 className="font-display text-[3.4vw] font-bold leading-[1.04] tracking-tight max-w-[65vw]">Exit &amp; long-term vision.</h2>
        
        <div className="mt-[4vh] flex-1 ">
          <ul className="space-y-[1.6vh]">            <li className="flex gap-[1vw]"><span className="font-display text-[1.4vw] text-fuchsia-300 leading-none">&rarr;</span><div><div className="font-display text-[1.4vw] font-semibold">Path 1 · Strategic</div><div className="mt-[0.4vh] text-[1.05vw] text-slate-300 leading-snug">Adjacent platforms (creator, CRM, comms) acquiring the identity layer.</div></div></li>
            <li className="flex gap-[1vw]"><span className="font-display text-[1.4vw] text-fuchsia-300 leading-none">&rarr;</span><div><div className="font-display text-[1.4vw] font-semibold">Path 2 · Growth</div><div className="mt-[0.4vh] text-[1.05vw] text-slate-300 leading-snug">Continue compounding to a category-defining platform.</div></div></li>
            <li className="flex gap-[1vw]"><span className="font-display text-[1.4vw] text-fuchsia-300 leading-none">&rarr;</span><div><div className="font-display text-[1.4vw] font-semibold">Path 3 · IPO</div><div className="mt-[0.4vh] text-[1.05vw] text-slate-300 leading-snug">Long-term scenario at $200M+ ARR with healthy margins.</div></div></li></ul>
          
        </div>
      </div>
      <div className="absolute bottom-[3vh] left-[5vw] right-[5vw] flex items-center justify-between text-[0.9vw] text-slate-500 z-10"><span>1inme.com</span><span>165 / 188</span></div>
    </div>
  );
}
