...
export default function Slide130Coachesexpertsfitnesstrainer() {
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-[#0a0a14] text-slate-100 font-body">
      ...
      <div className="relative h-full w-full px-[7vw] pt-[11vh] pb-[8vh] flex flex-col">
        <h2 className="font-display text-[3.4vw] font-bold leading-[1.04] tracking-tight">A day in the life — fitness trainers.</h2>
        ...
        <div className="mt-[4vh] flex-1 flex flex-col gap-[1.6vh]">
          <div className="grid grid-cols-12 gap-[1.5vw] items-start">
            <div className="col-span-2 font-display text-[1.6vw] font-bold text-fuchsia-200">6:00</div>
            <div className="col-span-3 text-[1.05vw] text-slate-400">Calendar</div>
            <div className="col-span-7 text-[1.1vw] text-slate-200 leading-snug">Confirms morning client sessions.</div>
          </div>
          <div className="grid grid-cols-12 gap-[1.5vw] items-start">
            ...
            <div className="col-span-7 text-[1.1vw] text-slate-200 leading-snug">Sends today&rsquo;s plan to clients securely.</div>
          </div>
          <div className="grid grid-cols-12 gap-[1.5vw] items-start">
            ...
            <div className="col-span-7 text-[1.1vw] text-slate-200 leading-snug">Check-in calls with last week&rsquo;s no-shows.</div>
          </div>
          <div className="grid grid-cols-12 gap-[1.5vw] items-start">
            ...
            <div className="col-span-7 text-[1.1vw] text-slate-200 leading-snug">Weekly progress survey to all clients.</div>
          </div>
          <div className="grid grid-cols-12 gap-[1.5vw] items-start">
            ...
            <div className="col-span-7 text-[1.1vw] text-slate-200 leading-snug">Sees who&rsquo;s drifting and re-engages.</div>
          </div>
        </div>
      </div>
      <div className="absolute bottom-[3vh] left-[5vw] right-[5vw] flex items-center justify-between text-[0.9vw] text-slate-500 z-10"><span>1inme.com</span><span>131 / 189</span></div>
    </div>
  );
}
