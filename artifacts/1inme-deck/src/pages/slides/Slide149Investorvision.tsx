...
export default function Slide149Investorvision() {
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-[#0a0a14] text-slate-100 font-body">
      ...
      <div className="relative h-full w-full px-[7vw] pt-[11vh] pb-[8vh] flex flex-col">
        <h2 className="font-display text-[3.4vw] font-bold leading-[1.04] tracking-tight max-w-[65vw]">Vision.</h2>
        <p className="mt-[2vh] text-[1.3vw] text-slate-300 max-w-[65vw]">Replace fragmented tooling with a single identity-first platform for every creator and team.</p>
        <div className="mt-[4vh] flex-1 ">
          <ul className="space-y-[1.6vh]">            <li className="flex gap-[1vw]"><span className="font-display text-[1.4vw] text-fuchsia-300 leading-none">&rarr;</span><div><div className="font-display text-[1.4vw] font-semibold">Identity is the new homepage</div><div className="mt-[0.4vh] text-[1.05vw] text-slate-300 leading-snug">1inme.com/you replaces every link in bio.</div></div></li>
            <li className="flex gap-[1vw]"><span className="font-display text-[1.4vw] text-fuchsia-300 leading-none">&rarr;</span><div><div className="font-display text-[1.4vw] font-semibold">AI is the new operating system</div><div className="mt-[0.4vh] text-[1.05vw] text-slate-300 leading-snug">Companions automate the work between modules.</div></div></li>
            <li className="flex gap-[1vw]"><span className="font-display text-[1.4vw] text-fuchsia-300 leading-none">&rarr;</span><div><div className="font-display text-[1.4vw] font-semibold">One bill, one brand, one home</div><div className="mt-[0.4vh] text-[1.05vw] text-slate-300 leading-snug">From first link to last invoice.</div></div></li></ul>
          
        </div>
      </div>
      <div className="absolute bottom-[3vh] left-[5vw] right-[5vw] flex items-center justify-between text-[0.9vw] text-slate-500 z-10"><span>1inme.com</span><span>150 / 189</span></div>
    </div>
  );
}
