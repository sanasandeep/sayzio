...
export default function Slide142Teamsagenciesteamsagenciesdi() {
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-[#14091f] text-slate-100 font-body">
      ...
      <div className="relative h-full w-full px-[7vw] pt-[11vh] pb-[8vh] flex flex-col">
        <div className="flex-1 flex flex-col justify-center">
          ...
          <h2 className="mt-[2vh] font-display text-[7vw] font-bold leading-[0.94] tracking-tight max-w-[80vw]">How 1INME helps a teams &amp; agencies.</h2>
      ...
      <div className="absolute bottom-[3vh] left-[5vw] right-[5vw] flex items-center justify-between text-[0.9vw] text-slate-500 z-10"><span>1inme.com</span><span>143 / 189</span></div>
    </div>
  );
}
