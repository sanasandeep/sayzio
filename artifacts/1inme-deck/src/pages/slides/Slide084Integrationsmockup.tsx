...
export default function Slide084Integrationsmockup() {
  return (
      ...
      <div className="relative h-full w-full px-[7vw] pt-[11vh] pb-[8vh] flex flex-col">
        <div className="grid grid-cols-12 gap-[2.5vw] flex-1">
          <div className="col-span-5 flex flex-col justify-center">
            <h2 className="font-display text-[3.2vw] font-bold leading-[1.04] tracking-tight">Integrations — in product.</h2>
          ...
          <div className="col-span-7 rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.06] to-white/[0.02] p-[1.6vw] flex flex-col">
            <div className="flex items-center gap-[0.5vw] pb-[1vh] border-b border-white/10">
              ...
              <span className="ml-[1vw] text-[0.9vw] text-slate-400 font-mono">Connected services</span>
            </div>
            <div className="mt-[1.5vh] flex flex-col gap-[0.7vh]">
            <div className="rounded-lg border border-white/10 bg-white/[0.03] px-[1vw] py-[0.8vh] flex items-center justify-between"><span className="text-[1vw] text-slate-200">HubSpot</span><span className="text-[0.9vw] text-fuchsia-200 font-mono">syncing · contacts</span></div>
            <div className="rounded-lg border border-white/10 bg-white/[0.03] px-[1vw] py-[0.8vh] flex items-center justify-between"><span className="text-[1vw] text-slate-200">Stripe</span><span className="text-[0.9vw] text-fuchsia-200 font-mono">payouts last 30d</span></div>
            <div className="rounded-lg border border-white/10 bg-white/[0.03] px-[1vw] py-[0.8vh] flex items-center justify-between"><span className="text-[1vw] text-slate-200">Slack</span><span className="text-[0.9vw] text-fuchsia-200 font-mono">alerts on new lead</span></div>
            <div className="rounded-lg border border-white/10 bg-white/[0.03] px-[1vw] py-[0.8vh] flex items-center justify-between"><span className="text-[1vw] text-slate-200">Google Calendar</span><span className="text-[0.9vw] text-fuchsia-200 font-mono">two-way sync</span></div>
            </div>
            <div className="mt-auto pt-[1.5vh] text-[0.9vw] text-slate-500">Token-scoped access with full audit trail.</div>
          </div>
        </div>
      </div>
      <div className="absolute bottom-[3vh] left-[5vw] right-[5vw] flex items-center justify-between text-[0.9vw] text-slate-500 z-10"><span>1inme.com</span><span>84 / 188</span></div>
    </div>
  );
}
