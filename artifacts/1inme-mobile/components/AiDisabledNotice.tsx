...
const FEATURE_BLURBS: Record<string, string> = {
  "AI Note Summarizer":
    "AI Note Summarizer is your personal AI Mind: it learns from your sources so the assistant can answer in your voice.",
  "AI Minds":
    "AI Minds let you build and manage several AI Minds, each trained on its own set of sources.",
  ...
  "AI Link Optimizer":
    "AI Link Optimizer gives you AI-powered suggestions to grow and fine-tune your links and pages.",
  "AI Coach":
        ...
        {variant === "engine" ? (
          ...
          >
            ...
            <Text style={[styles.infoBody, { color: colors.mutedForeground }]}>
              AI features on Sayzio (like AI Minds, AI Agents, AI Chat
              and AI Link Optimizer) help you draft content, answer questions about your account
