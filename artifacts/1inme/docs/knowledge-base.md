...
(your handle, e.g. `sayzio.app/@yourname`).
...
| **Text Page** | Paste or type any text and share it as a clean page behind a short link. Visitors can select the text or copy it all with one tap, and every view is tracked. |
