...
class PlansAndAddonsSeeder extends Seeder
{
        ...
        return [
            ...
            [
                ...
                'features' => [
                    ...
                    'max_brand_kit_pages' => 10,
                    'max_updates_pages' => 10,
                    'max_text_pages' => 10,
                    'max_file_size_mb' => 50,
    ...
    private function addonDefinitions(): array
    {
        ...
        return [
            ...
            [
                'name' => 'Extra Paid Pages', 'slug' => 'extra-paid-pages',
                'description' => 'Add 5 more paid, members-only content pages on top of your plan.',
                'type' => 'recurring', 'monthly_price' => 4.00, 'annual_price' => 40.00,
                'features' => ['max_paid_page_extra' => 5],
                'status' => 'active', 'sort_order' => 15, 'applies_to' => $paid,
            ],
            [
                'name' => 'AI Agents Pack', 'slug' => 'ai-agents-pack',
                'description' => 'Unlock the Inbox Agent, WhatsApp AI Agent and AI Marketing Strategist on your plan.',
                'type' => 'recurring', 'monthly_price' => 9.00, 'annual_price' => 90.00,
                'features' => ['inbox_agent' => true, 'whatsapp_agent' => true, 'marketing_strategist' => true],
                'status' => 'active', 'sort_order' => 16, 'applies_to' => ['creator'],
            ],
            [
