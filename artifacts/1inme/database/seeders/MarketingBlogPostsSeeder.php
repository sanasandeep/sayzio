        ...
        return [
            ...
            'smart-links-101' => [
                ['heading' => 'Three campaigns to try smart links on first', 'list_type' => 'ol', 'list' => [
                    'Your next product or content launch — route mobile vs desktop visitors to format-appropriate landing pages.',
            ...
            'sponsorships-101-first-brand-deal' => [
                ['heading' => 'Build a tiny media kit', 'paragraphs' => [
                    'A one-page PDF with your audience size, demographics, top recent posts, and three short testimonials from past partners (even unpaid ones) closes more deals than a glossy ten-page kit. Brands skim — make the skim productive. Update it once a quarter so the numbers stay current.',
                ]],
            ],
            ...
            'internal-linking-for-creators' => [
                ['heading' => 'Treat your archive as live', 'paragraphs' => [
                    'Old posts are not done. Once a quarter, pick five high-traffic posts from your archive and add fresh internal links to anything you have published since. Updating the publish date is optional, but adding new links is one of the highest-ROI things you can do for an existing post — it brings the post back into Google\'s freshness signals and helps the new pages get discovered faster.',
                ]],
            ],
    ...
    private function posts(): array
    {
        return [
            ...
            [
                ...
                'excerpt' => 'When and why to use a smart link instead of a plain short link — with three concrete creator examples.',
            ...
            [
                ...
                'sections' => [
                    ...
                    ['heading' => 'Weeks 5–8: collaborations', 'paragraphs' => [
                        'Reach out to ten creators in adjacent niches with under 5,000 followers and offer to collaborate on something small — a co-written post, a guest appearance, a joint giveaway. At this size everyone is eager to grow and the maths of cross-pollination work in your favour. Big creators won\'t reply; peers will.',
            ...
            [
                ...
                'excerpt' => 'Why creators eventually all gravitate to recurring revenue — and how to start without a huge audience.',
            ...
            [
                ...
                'sections' => [
                    ['heading' => 'A faster, calmer editor', 'paragraphs' => [
                        'The biolink editor is now noticeably snappier on slower connections, with a new mobile preview that updates as you type. Drag-and-drop reordering also works on touch screens — finally — so editing your page from a phone while travelling is no longer an exercise in frustration.',
