...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('vault_credentials')) {
        ...
        if (!Schema::hasTable('vault_clients')) {
        ...
        if (!Schema::hasTable('vault_client_emails')) {
        ...
        if (!Schema::hasTable('vault_client_phones')) {
        ...
        if (!Schema::hasTable('vault_client_addresses')) {
        ...
        if (!Schema::hasTable('vault_attachments')) {
        ...
        if (!Schema::hasTable('vault_audit')) {
