...
/**
 * Refresh the five long-form legal policy pages with the company-identity
 * generation of defaults: governing-law jurisdiction tokens, AWS hosting
 * + AI sub-processor disclosures, and the analytics / marketing-pixel
 * tracking disclosures.
 *
 * Follows the established seed-version pattern: a page that still holds an
 * untouched earlier default (richDefaults or policyDefaultsV1, matched by
 * exact section content) is replaced wholesale and re-stamped to today;
 * an admin-edited page only receives the new disclosure sections appended
