    ...
    private function seedHints(): array
    {
        return [
            [
                ...
                'surface'           => 'marketing',
                'description'       => 'Page where visitors compare Sayzio plans. Lead them to start a free trial or contact sales.',
            ...
            [
                ...
                'route_pattern'     => '/',
                'surface'           => 'marketing',
                'description'       => 'The Sayzio marketing landing page introducing the product. Help visitors understand what Sayzio is.',
                'suggested_actions' => [['label' => 'What is Sayzio?'], ['label' => 'See features'], ['label' => 'Sign up free']],
                'priority'          => 50,
            ],
            [
                'label'             => 'Auth pages',
