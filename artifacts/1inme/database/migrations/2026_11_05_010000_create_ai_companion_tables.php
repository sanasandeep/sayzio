...
return new class extends Migration {
    ...
    {
        if (!Schema::hasTable('ai_companions')) {
        ...
        if (!Schema::hasTable('ai_companion_links')) {
        ...
        if (!Schema::hasTable('ai_companion_conversations')) {
        ...
        if (!Schema::hasTable('ai_companion_messages')) {
        ...
        Schema::table('viewer_dm_conversations', function (Blueprint $table) {
            if (!Schema::hasColumn('viewer_dm_conversations', 'auto_reply_companion_id')) {
        ...
        Schema::table('viewer_dm_messages', function (Blueprint $table) {
            if (!Schema::hasColumn('viewer_dm_messages', 'is_ai')) {
