...
return new class extends Migration {
    public function up(): void
    {
        ...
        if (!Schema::hasTable('block_comments')) {
        ...
        if (!Schema::hasTable('block_reactions')) {
        ...
        if (!Schema::hasTable('block_polls')) {
        ...
        if (!Schema::hasTable('block_poll_votes')) {
        ...
        if (!Schema::hasTable('fan_leaderboard_settings')) {
