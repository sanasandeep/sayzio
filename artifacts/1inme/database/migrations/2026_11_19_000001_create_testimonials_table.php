...
return new class extends Migration {
    ...
    private function seedDefaults(): void
    {
        ...
        $top = [
            ...
            ['The Performance Coach is like having a growth marketer on speed-dial.', 'Devon S.', 'Indie founder', '#3d6bff'],
            ...
            ['NFC tags on every business card — I just tap and people land on my page. Magic.', 'Hugo R.', 'Real-estate agent', '#3d6bff'],
        ...
        $bottom = [
            ...
            ['Live geo heatmap showed us our biggest market is Berlin. Who knew?', 'Pablo M.', 'Music producer', '#3d6bff'],
            ...
            ['I built my entire merch store as a biolink page. No Shopify needed.', 'Zoe B.', 'Streetwear designer', '#3d6bff'],
            ...
            ['Dark theme + custom fonts make it feel like *my* site, not a template.', 'Jordan F.', 'Photographer', '#3d6bff'],
            ...
            ['I run my agency’s lead-gen entirely from one Sayzio page.', 'Carla S.', 'Agency owner', '#3d6bff'],
            ...
            ['The follower system means I email superfans without paying Mailchimp.', 'Fatima E.', 'Author', '#3d6bff'],
