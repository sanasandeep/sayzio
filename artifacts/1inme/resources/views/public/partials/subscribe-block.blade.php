...
<section class="pb-24" aria-labelledby="subscribe-block-h-{{ $__sbSource }}">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-8">
            ...
            <h2 id="subscribe-block-h-{{ $__sbSource }}" class="text-2xl sm:text-3xl font-bold text-white">{{ $__sbHeading }}</h2>
            <p class="mt-2 text-gray-400 max-w-2xl mx-auto text-sm leading-relaxed">{{ $__sbSubtext }}</p>
        </div>
        ...
        <div class="grid grid-cols-1 {{ $__sbGridCols }} gap-4">
            ...
            <div class="bg-gradient-to-br from-violet-500/15 via-fuchsia-500/10 to-transparent border border-violet-400/20 rounded-2xl p-6 flex flex-col">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        <h3 class="text-base font-bold text-white">Email newsletter</h3>
                        <p class="text-[11px] text-gray-400">Monthly · in your inbox</p>
                    </div>
                </div>
                <p class="text-xs text-gray-400 leading-relaxed mb-4">Long-form notes, playbooks, and templates. Once a month, easy to skim.</p>
            ...
            @if($__sbHasWaChan)
                ...
                <div class="bg-gradient-to-br from-emerald-500/15 via-teal-500/10 to-transparent border border-emerald-400/20 rounded-2xl p-6 flex flex-col">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            <h3 class="text-base font-bold text-white">WhatsApp Channel</h3>
                            <p class="text-[11px] text-gray-400">Broadcast · read-only</p>
                        </div>
                    </div>
                    <p class="text-xs text-gray-400 leading-relaxed mb-4">Quick announcements, drops and tips, straight to your WhatsApp. One tap to follow.</p>
                    <a href="{{ $__sbWaUrl }}"
                       target="_blank"
            ...
            @if($__sbHasWaDm)
                ...
                <div class="bg-gradient-to-br from-emerald-500/15 via-lime-500/10 to-transparent border border-emerald-400/20 rounded-2xl p-6 flex flex-col">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            <h3 class="text-base font-bold text-white">Chat on WhatsApp</h3>
                            <p class="text-[11px] text-gray-400">1:1 · talk to a human</p>
                        </div>
                    </div>
                    <p class="text-xs text-gray-400 leading-relaxed mb-4">Questions, demo requests, partnership ideas — DM us and we'll get back fast.</p>
                    <a href="{{ $__sbWaDmHref }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       data-source="{{ $__sbSubmitSource }}"
        ...
        <div class="text-center mt-5">
            <a href="{{ route('site.subscriptions.manage') }}"
               class="inline-flex items-center gap-1.5 text-[12px] text-gray-500 hover:text-violet-300 underline-offset-2 hover:underline">
