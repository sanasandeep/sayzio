...
@endphp
@if($__stats->count())
<section class="sec-rule py-14 lg:py-20 relative overflow-hidden">
    ...
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-10">
            ...
            <p class="reveal rd-2 text-gray-400 max-w-xl mx-auto mt-3 text-sm sm:text-base">Real numbers from real creators, brands and teams growing with Sayzio's AI every day.</p>
        </div>
