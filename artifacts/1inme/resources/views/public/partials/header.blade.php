    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden lg:flex items-center gap-x-4 xl:gap-x-6 min-w-0 flex-1 justify-center px-4">
                ...
                <a href="{{ route('site.discovery') }}" class="text-sm text-gray-300 hover:text-violet-400 whitespace-nowrap">Discover</a>
                <a href="{{ route('site.creators-feed') }}" class="text-sm text-gray-300 hover:text-violet-400 whitespace-nowrap">Feed</a>
                <a href="{{ route('site.api-docs') }}" class="text-sm text-gray-300 hover:text-violet-400 whitespace-nowrap">API</a>
                <a href="{{ route('site.about') }}" class="text-sm text-gray-300 hover:text-violet-400 whitespace-nowrap">About</a>
                <a href="{{ route('site.contact') }}" class="text-sm text-gray-300 hover:text-violet-400 whitespace-nowrap">Contact</a>
            </div>
            ...
            <button @click="mobileOpen=!mobileOpen" class="lg:hidden p-2 text-gray-300" aria-label="Toggle menu">
