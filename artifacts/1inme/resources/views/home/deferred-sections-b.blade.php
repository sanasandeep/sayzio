...
<div id="ai-zone" class="ai-zone sec-ground relative overflow-hidden">
    ...
    {{-- Shared zone intro --}}
    <section class="sec-rule relative pt-24 lg:pt-32 pb-2" aria-labelledby="ai-zone-h">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="reveal rd-3 mt-7 flex flex-wrap items-center justify-center gap-2.5">
                <a href="/features" class="ai-zone-chip"><i class="fas fa-robot"></i> Chatbot &amp; Agent</a>
