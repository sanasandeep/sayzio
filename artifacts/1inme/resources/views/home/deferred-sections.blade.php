{{-- The proof band, "what you can create" and the audience section used to
     open this file. They are server-rendered into the initial HTML now, in
     home/above-fold-sections.blade.php, because the crawler's first pass at
     this page found zero h2s, zero h3s and one internal link -- everything
     was behind this fetch. That file explains the reasoning; this fragment
     picks up where it leaves off, at "how it works".

     They were MOVED, not copied. Rendering them in both places would put two
     of each heading on the page. --}}
