...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('admin.roles.create') }}" class="px-4 py-2 bg-violet-600 text-white rounded-xl text-sm font-medium hover:bg-violet-700 transition">
    ...
    <div class="glass rounded-2xl border border-white/10  p-6">
        <div class="flex items-center justify-between mb-3">
            ...
            @if($role->slug === 'super-admin')
                <span class="text-xs bg-violet-500/10 text-violet-400 px-2 py-0.5 rounded-full">System</span>
            @endif
        </div>
