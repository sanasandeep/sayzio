            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="description" rows="2"
                              class="w-full px-4 py-2.5 bg-white/5 border border-white/10 rounded-xl text-white focus:ring-2 focus:ring-purple-500/40 outline-none">{{ old('description', $role->description) }}</textarea>
                </div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                            ...
                            <label class="flex items-center gap-2 text-sm text-white/60 p-2 rounded hover:bg-white/5">
                                <input type="checkbox" name="permissions[]" value="{{ $perm->id }}"
                                       ...
                                       class="rounded border-white/10 text-purple-400 focus:ring-purple-500/40">
                                {{ $perm->name }}
                            </label>
                            @endforeach
                        </div>
                ...
                <div class="flex items-center gap-3 pt-4">
                    <button type="submit" class="px-6 py-2.5 bg-purple-600 text-white rounded-xl font-medium hover:bg-purple-700 transition">Update Role</button>
