...
<div class="max-w-2xl space-y-6">
    ...
    <form method="POST" action="{{ route('admin.integrations.google-analytics.update') }}" class="space-y-6">
        ...
        <div class="glass rounded-2xl border border-white/10 p-6 space-y-5">
            ...
            <label class="ak-strong flex items-center gap-3 text-sm text-white/70">
            ...
            <p class="ak-note text-[11px] text-white/30">When disabled, the GA4 option shows as &ldquo;coming soon&rdquo; in the creator Connected Apps area. No events are forwarded regardless of any existing creator connections.</p>
        </div>
