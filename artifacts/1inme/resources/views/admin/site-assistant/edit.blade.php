        ...
        <div class="glass rounded-2xl border border-white/10 p-6 space-y-4">
            ...
            <div class="grid md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" maxlength="60" name="brand_name" id="assistant_brand_name" value="{{ $cfg['brand_name'] ?? '' }}" placeholder="{{ \App\Services\AI\SiteAssistantSettings::DEFAULT_BRAND_NAME }}" class="w-full bg-black/30 border border-white/10 rounded-lg px-3 py-2 text-sm text-white">
            ...
            <div class="grid md:grid-cols-[88px,1fr] gap-4 items-start">
                <div class="rounded-xl p-2 flex flex-col items-center justify-center gap-1.5" style="background:rgba(255,255,255,0.04); border:1px solid var(--border-glass); min-height:80px;">
                    ...
                    <span id="assistant_name_preview" class="text-[11px] text-white/60 text-center leading-tight max-w-full truncate">{{ trim($cfg['brand_name'] ?? '') !== '' ? $cfg['brand_name'] : \App\Services\AI\SiteAssistantSettings::DEFAULT_BRAND_NAME }}</span>
                </div>
                <div class="space-y-2">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="avatar_url" id="assistant_avatar_url" value="{{ $cfg['avatar_url'] }}" class="w-full bg-black/30 border border-white/10 rounded-lg px-3 py-2 text-sm text-white" placeholder="https://…">
