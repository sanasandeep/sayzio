...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('admin.staff.create') }}" class="px-4 py-2 bg-purple-600 text-white rounded-xl text-sm font-medium hover:bg-purple-700 transition">
            ...
            <tr class="hover:bg-white/5">
                ...
                <td class="px-6 py-4 text-right">
                    <div class="flex items-center justify-end gap-2">
                        <a href="{{ route('admin.staff.edit', $member) }}" class="text-white/30 hover:text-purple-400"><i class="fas fa-edit"></i></a>
