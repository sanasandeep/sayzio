        ...
        <form method="POST" action="{{ route('admin.plans.store') }}">
            ...
            <div class="space-y-5">
                ...
                <div class="border-t border-dark-200 pt-5">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-3 mt-4">
                        ...
                        <label class="flex items-center gap-2 text-sm text-dark-600 p-2 rounded hover:bg-dark-50">
                            <input type="checkbox" name="features[{{ $key }}]" value="1" class="rounded border-dark-300 text-primary-600">
                            {{ $label }}
                        </label>
                        @endforeach
                    </div>
                ...
                <div class="flex items-center gap-3 pt-4">
                    <button type="submit" class="px-6 py-2.5 bg-primary-600 text-white rounded-lg font-medium hover:bg-primary-700 transition">Create Plan</button>
