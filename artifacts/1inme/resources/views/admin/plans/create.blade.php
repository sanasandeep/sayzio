            ...
            <div class="space-y-5">
                        ...
                        <div class="rounded-xl border border-white/10 p-4 bg-white/[0.02]">
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <input type="number" name="monthly_price" value="{{ old('monthly_price', '0') }}" step="1" min="0" required
                                ...
                                <div>
                                    ...
                                    <input type="number" name="annual_price" value="{{ old('annual_price', '0') }}" step="1" min="0" required
                                           class="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-xl text-white text-sm focus:ring-2 focus:ring-violet-500/40 outline-none">
                                </div>
                            </div>
                        </div>
                        <div class="rounded-xl border border-white/10 p-4 bg-white/[0.02]">
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <input type="number" name="monthly_price_secondary" value="{{ old('monthly_price_secondary', '0') }}" step="1" min="0" required
                                           class="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-xl text-white text-sm focus:ring-2 focus:ring-violet-500/40 outline-none">
                                </div>
                                <div>
                                    <label class="block text-xs text-white/40 mb-1">Annual (INR, paise)</label>
                                    <input type="number" name="annual_price_secondary" value="{{ old('annual_price_secondary', '0') }}" step="1" min="0" required
                                           class="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-xl text-white text-sm focus:ring-2 focus:ring-violet-500/40 outline-none">
                                </div>
                            </div>
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="grace_days" value="{{ old('grace_days', '7') }}" min="0" max="365" required
                               class="w-full px-4 py-2.5 bg-white/5 border border-white/10 rounded-xl text-white focus:ring-2 focus:ring-violet-500/40 outline-none">
                    ...
                    <div>
                        ...
                        <input type="number" name="refund_window_days" value="{{ old('refund_window_days', '7') }}" min="0" max="365" required
                               class="w-full px-4 py-2.5 bg-white/5 border border-white/10 rounded-xl text-white focus:ring-2 focus:ring-violet-500/40 outline-none">
