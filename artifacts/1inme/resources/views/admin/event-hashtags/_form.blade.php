...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
        <label class="block text-[11px] uppercase tracking-wider text-white/50 font-bold mb-1.5">
            Hashtag <span class="text-white/30 normal-case">(without #)</span>
        </label>
    ...
    <div>
        ...
        <p class="text-[11px] text-white/40 mt-1.5">Lower numbers show first, ahead of auto-trending tags.</p>
    </div>
</div>
