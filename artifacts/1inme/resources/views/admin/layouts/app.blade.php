        ...
        <div x-show="mobileMenu" @click.away="mobileMenu = false" x-cloak
            ...
            <div class="w-[280px] h-full flex flex-col" style="background: var(--bg-sidebar-mobile);">
                ...
                <nav class="flex-1 py-4 px-3 space-y-0.5 overflow-y-auto">
                    ...
                    <a href="{{ route('admin.bg-catalog.index', 'preset') }}" class="sidebar-link {{ request()->routeIs('admin.bg-catalog.*') ? 'active' : '' }}"><div class="nav-icon-wrap"><i class="fas fa-swatchbook"></i></div><span>Background Library</span></a>
                    ...
                    <a href="{{ route('admin.android-apk.index') }}" class="sidebar-link {{ request()->routeIs('admin.android-apk.*') ? 'active' : '' }}"><div class="nav-icon-wrap"><i class="fa-brands fa-android"></i></div><span>Android APK</span></a>
                    ...
                    <a href="{{ route('admin.coin-ledger.index') }}" class="sidebar-link {{ request()->routeIs('admin.coin-ledger.*') ? 'active' : '' }}"><div class="nav-icon-wrap"><i class="fas fa-book-open"></i></div><span>Coin Ledger</span></a>
                    ...
                    <a href="{{ route('admin.marketing-plan-tool-costs.index') }}" class="sidebar-link {{ request()->routeIs('admin.marketing-plan-tool-costs.*') ? 'active' : '' }}"><div class="nav-icon-wrap"><i class="fas fa-calculator"></i></div><span>Plan Tool Costs</span></a>
