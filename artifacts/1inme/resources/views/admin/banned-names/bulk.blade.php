...
<div class="max-w-3xl">
    <div class="glass rounded-2xl border border-white/10 p-6">
        <form method="POST" action="{{ route('admin.banned-names.bulk.store') }}"
            ...
            <div>
                <h2 class="text-lg font-semibold text-white/90">Bulk import</h2>
            ...
            <div>
                <label class="block text-[11px] uppercase tracking-wider text-white/50 font-bold mb-1.5">
                    Or upload CSV / text file <span class="text-white/30 normal-case">(optional, max 2 MB)</span>
                </label>
            ...
            <div>
                <label class="block text-[11px] uppercase tracking-wider text-white/50 font-bold mb-1.5">
                    Note for all imported entries <span class="text-white/30 normal-case">(optional)</span>
                </label>
