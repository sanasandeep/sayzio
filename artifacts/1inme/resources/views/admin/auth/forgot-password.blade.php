...
<body class="bg-gradient-to-br from-gray-800 to-gray-900 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-400 mt-2">Admin Password Reset</p>
        </div>

        <div class="bg-white rounded-2xl shadow-lg p-8">
            <h2 class="text-xl font-semibold text-gray-800 mb-2">Forgot Password?</h2>
            <p class="text-gray-500 text-sm mb-6">Enter your admin email to receive a reset link.</p>
            ...
            <form method="POST" action="{{ route('admin.password.email') }}">
                ...
                <button type="submit" class="w-full bg-gray-800 hover:bg-gray-900 text-white py-2.5 rounded-lg text-sm font-medium">Send Reset Link</button>
            </form>

            <p class="text-center text-sm text-gray-500 mt-6">
                <a href="{{ route('admin.login') }}" class="text-gray-700 hover:text-gray-900">Back to login</a>
            </p>
        </div>
    </div>
</body>
