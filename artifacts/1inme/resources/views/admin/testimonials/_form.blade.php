...
<div class="grid md:grid-cols-2 gap-5">
    <div class="md:col-span-2">
        ...
        <textarea name="quote" rows="3" required maxlength="600"
                  class="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm text-white/90 focus:border-violet-400 focus:outline-none"
    ...
    <div>
        ...
        <div class="flex items-center gap-2">
            <input type="color" name="accent_color"
                   value="{{ old('accent_color', $t->accent_color ?? '#7c3aed') }}"
    ...
    <div class="md:col-span-2">
        <label class="inline-flex items-center gap-2 text-sm text-white/80 cursor-pointer">
            <input type="checkbox" name="is_active" value="1"
                   ...
                   class="rounded bg-white/5 border-white/20 text-violet-500 focus:ring-violet-500">
