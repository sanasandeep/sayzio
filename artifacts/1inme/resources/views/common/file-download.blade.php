...
<body class="min-h-screen flex items-center justify-center p-4 text-white">
    ...
    <div class="w-full max-w-lg relative z-10">
        <div class="glass rounded-2xl p-8 text-center">
            ...
            <div class="w-16 h-16 bg-purple-500/10 border border-purple-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                @if($isImage)
                ...
                @else
                    <svg class="w-8 h-8 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
                @endif
            </div>
            ...
            <p class="text-xs text-white/20 mt-4">Shared via <span class="text-white/30">1IN</span><span class="text-purple-400/60">ME</span></p>
        </div>
    </div>
