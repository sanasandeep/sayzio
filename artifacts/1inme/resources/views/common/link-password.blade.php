    ...
    <div class="w-full max-w-sm relative z-10">
        <div class="glass rounded-2xl p-8 text-center">
            ...
            <form method="POST" action="{{ route('redirect.handle', $link->alias) }}">
                ...
                <button type="submit" class="w-full py-2.5 rounded-[0.625rem] text-sm font-semibold text-white transition-all" style="background: linear-gradient(135deg, #8b5cf6, #7c3aed); box-shadow: 0 4px 16px rgba(124,58,237,0.25);">Continue</button>
            </form>
        </div>
        <p class="text-center text-xs text-white/20 mt-4">Powered by <span class="text-white/30">1IN</span><span class="text-violet-400/60">ME</span></p>
    </div>
