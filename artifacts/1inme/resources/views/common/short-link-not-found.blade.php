...
<section class="pb-20">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-gradient-to-br from-violet-500/[0.10] to-blue-500/[0.06] border border-violet-400/20 rounded-2xl p-6 sm:p-10 text-center">
            ...
            <div class="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
                <a href="{{ $registerUrl }}"
                   class="inline-flex items-center justify-center px-6 py-3 bg-[#7c3aed] hover:bg-[#6d28d9] text-white rounded-full text-sm font-bold transition">
