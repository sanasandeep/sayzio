    <a href="{{ $s['url'] ?? '#' }}" target="_blank" class="mb-3 glass-block rounded-xl p-4 flex items-center gap-3 block hover:bg-white/[0.06] transition">
        <div class="w-11 h-11 rounded-xl bg-indigo-500/20 flex items-center justify-center"><i class="{{ fa_icon_class($s['icon'] ?? 'fas fa-file-download', 'fas fa-file-download') }} text-indigo-400"></i></div>
