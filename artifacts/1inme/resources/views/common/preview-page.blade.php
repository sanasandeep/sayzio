    ...
    <div class="w-full max-w-lg relative z-10">
        <div class="glass rounded-2xl p-8 text-center">
            <div class="w-16 h-16 bg-blue-500/10 border border-blue-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                @switch($icon)
                    ...
                    @case('calendar')
                        ...
                        @break
                    @case('user')
                        <svg class="w-8 h-8 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                        @break
                    @default
                        <svg class="w-8 h-8 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 015.656 5.656l-4 4a4 4 0 01-5.656-5.656m-1.656 1.656a4 4 0 01-5.656-5.656l4-4a4 4 0 015.656 5.656"/></svg>
                @endswitch
            </div>
            ...
            <a href="{{ $continueUrl }}" class="inline-flex items-center justify-center gap-2 w-full text-white px-6 py-3 rounded-xl font-semibold transition-all"
               style="background: linear-gradient(135deg, #5c83ff, #3d6bff); box-shadow: 0 4px 16px rgba(61,107,255,0.25);">
                {{ $actionLabel }}
