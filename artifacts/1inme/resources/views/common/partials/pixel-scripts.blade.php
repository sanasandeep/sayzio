...
@foreach($link->pixels as $pixel)
    ...
    <script type="text/javascript">_linkedin_partner_id="{{ $pixel->pixel_id }}";window._linkedin_data_partner_ids=window._linkedin_data_partner_ids||[];window._linkedin_data_partner_ids.push(_linkedin_partner_id);</script>
