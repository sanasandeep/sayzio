...
html.light-mode .block-settings-form .placeholder-banner { color:#3730a3; border-color: rgba(61,107,255,0.30); }
html.light-mode .block-settings-form .placeholder-banner i { color:#b45309; }
