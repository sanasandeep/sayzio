    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="glass rounded-2xl p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="text-sm text-violet-400 bg-violet-500/10 px-3 py-2 rounded-xl font-mono">{{ $link->getShortUrl() }}</div>
                </div>
        ...
        <div class="glass rounded-2xl p-6">
            ...
            <form id="downloadForm" method="POST" action="{{ route('user.links.qrcode.download', $link) }}" enctype="multipart/form-data">
                ...
                <button type="submit" class="w-full bg-violet-600 hover:bg-violet-700 text-white px-6 py-2.5 rounded-xl text-sm font-medium flex items-center justify-center gap-2">
