@php
    ...
    // Reuse the shared QR Studio design vocabulary so the store code is styled
    // consistently with the rest of the platform (tinted with the store accent).
...
<head>
    ...
    <style>
        * { box-sizing:border-box; }
        ...
        .place { font-size:24px; font-weight:800; margin:0 0 4px; color:#111; }
