                ...
                <div class="card-premium p-6" x-data="{ gtTab: 'templates', btnStyle: '{{ $btnStyle }}', btnColor: '{{ $btnColor }}', btnTextColor: '{{ $btnTextColor }}' }">
                    <div class="flex items-center justify-between mb-5">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-lg flex items-center justify-center" style="background: rgba(61,107,255,0.1);"><i class="fas fa-wand-magic-sparkles text-blue-400 text-xs"></i></div>
                            <h3 class="text-sm font-bold" style="color: var(--text-primary);">Global Block Theme</h3>
                        </div>
                        <label class="flex items-center gap-2 cursor-pointer px-3 py-1.5 rounded-lg transition-all" style="background: rgba(61,107,255,0.06); border: 1px solid rgba(61,107,255,0.12);">
                    ...
                    <div class="flex gap-1 p-0.5 rounded-lg mb-5" style="background: var(--bg-glass-input);">
                        ...
                        <button type="button" @click="gtTab = '{{ $tabKey }}'"
                                ...
                                :style="gtTab === '{{ $tabKey }}' ? 'background: linear-gradient(135deg, #5c83ff, #3d6bff);' : 'color: var(--text-faint);'"
                    ...
                    <div x-show="gtTab === 'fx'" class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="range" name="block_theme[glass_blur]" value="{{ $bt['glass_blur'] ?? 20 }}" min="0" max="100" class="w-full accent-indigo-500" oninput="this.nextElementSibling.textContent = this.value + 'px'">
                            ...
                            <div>
                                ...
                                <input type="range" name="block_theme[glass_opacity]" value="{{ $bt['glass_opacity'] ?? 15 }}" min="0" max="100" class="w-full accent-indigo-500" oninput="this.nextElementSibling.textContent = this.value + '%'">
