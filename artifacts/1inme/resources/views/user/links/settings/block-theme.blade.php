                ...
                <div class="card-premium p-6" x-data="{ gtTab: 'templates', btnStyle: '{{ $btnStyle }}', btnColor: '{{ $btnColor }}', btnTextColor: '{{ $btnTextColor }}' }">
                    <div class="flex items-center justify-between mb-5">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-lg flex items-center justify-center" style="background: rgba(124,58,237,0.1);"><i class="fas fa-wand-magic-sparkles text-violet-400 text-xs"></i></div>
                            <h3 class="text-sm font-bold" style="color: var(--text-primary);">Global Block Theme</h3>
                        </div>
                        <label class="flex items-center gap-2 cursor-pointer px-3 py-1.5 rounded-lg transition-all" style="background: rgba(124,58,237,0.06); border: 1px solid rgba(124,58,237,0.12);">
                            <input type="hidden" name="block_theme[apply_to_all]" value="0">
                            <input type="checkbox" name="block_theme[apply_to_all]" value="1" {{ ($bt['apply_to_all'] ?? false) ? 'checked' : '' }} class="rounded text-violet-500 focus:ring-violet-500/40 w-4 h-4" style="background: var(--bg-glass-input); border-color: var(--border-glass);">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                ...
                                <label class="flex items-center gap-2 p-3 rounded-xl cursor-pointer transition-all" style="background: var(--bg-glass-input); border: 1px solid var(--border-glass);">
                                    <input type="radio" name="block_theme[effect]" value="{{ $eVal }}" {{ ($bt['effect'] ?? 'none') === $eVal ? 'checked' : '' }} class="text-violet-500 focus:ring-violet-500/40" style="background: var(--bg-glass-input); border-color: var(--border-glass);">
                    ...
                    <div x-show="gtTab === 'buttons'" class="space-y-4">
                        <div>
                            ...
                            <div class="grid grid-cols-5 gap-2">
                                ...
                                <button type="button" @click="btnStyle = '{{ $val }}'"
                                    :class="btnStyle === '{{ $val }}' ? 'ring-2 ring-violet-500' : ''"
