...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white">Create Digital Card</h1>
    ...
    <form method="POST" action="{{ route('user.links.vcf.store') }}">
        ...
        <div class="flex items-center justify-end gap-3 mt-4">
            ...
            <button type="submit" class="bg-violet-600 hover:bg-violet-700 text-white px-6 py-2.5 rounded-xl text-sm font-medium">Create Digital Card</button>
        </div>
    </form>
</div>
@endsection
