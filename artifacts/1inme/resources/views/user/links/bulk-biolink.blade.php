        ...
        <div class="glass rounded-2xl p-6 mb-6">
            ...
            <div class="flex gap-1 mb-4 bg-white/5 p-1 rounded-xl w-fit">
                <button type="button" @click="source = 'template'"
                        :class="source === 'template' ? 'bg-blue-600 text-white' : 'text-white/60 hover:text-white'"
                ...
                <button type="button" @click="source = 'page'"
                        :class="source === 'page' ? 'bg-blue-600 text-white' : 'text-white/60 hover:text-white'"
                        class="px-4 py-1.5 rounded-lg text-xs font-medium transition-all">
            ...
            <div x-show="source === 'page'" x-cloak>
                ...
                @else
                    <select name="link_id" class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white focus:ring-2 focus:ring-blue-500/40 outline-none">
                        @foreach($pages as $p)
        ...
        <div class="glass rounded-2xl p-6 mb-6">
            ...
            <div class="flex gap-1 mb-4 bg-white/5 p-1 rounded-xl w-fit">
                ...
                <button type="button" @click="tab = 'file'"
                        :class="tab === 'file' ? 'bg-blue-600 text-white' : 'text-white/60 hover:text-white'"
                        class="px-4 py-1.5 rounded-lg text-xs font-medium transition-all">
            ...
            <div x-show="tab === 'paste'">
                ...
                <textarea name="sheet_text" rows="10"
                          ...
                          class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder-white/20 focus:ring-2 focus:ring-blue-500/40 outline-none font-mono">{{ old('sheet_text') }}</textarea>
            </div>
            ...
            <div x-show="tab === 'file'" x-cloak>
                ...
                <p class="text-[11px] text-white/40 mt-2">Accepts <code class="text-blue-300">.csv</code> and <code class="text-blue-300">.xlsx</code>. The first sheet is used.</p>
            </div>
        </div>
