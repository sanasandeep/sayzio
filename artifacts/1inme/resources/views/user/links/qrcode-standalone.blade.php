    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="glass rounded-2xl p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="url" x-model="url" placeholder="https://example.com" class="w-full border border-white/10 rounded-xl px-3 py-2.5 text-sm focus:ring-2 focus:ring-purple-500/40">
        ...
        <div class="glass rounded-2xl p-6">
            ...
            <form id="downloadForm" method="POST" action="{{ route('user.qrcode.download') }}" enctype="multipart/form-data">
                ...
                <button type="submit" :disabled="!url" class="w-full bg-purple-600 hover:bg-purple-700 text-white px-6 py-2.5 rounded-xl text-sm font-medium flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
