    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="space-y-4">
                ...
                <div x-show="format === 'png'">
                    ...
                    <p class="text-xs text-gray-400 mt-1">Optional logo centered on the QR code (PNG only, max 2MB)</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="mt-4 border-t pt-4" x-show="url">
                ...
                <div class="relative">
                    <textarea readonly class="w-full border border-gray-300 rounded-lg px-3 py-2 text-xs font-mono bg-gray-50 resize-none" rows="3" x-ref="embedCode" :value="'<img src=&quot;{{ route('qr.public.render') }}?url=' + encodeURIComponent(url) + '&size=' + size + '&fg_color=' + encodeURIComponent(fgColor) + '&bg_color=' + encodeURIComponent(bgColor) + '&error_correction=' + errorCorrection + '&quot; alt=&quot;QR Code&quot; width=&quot;' + size + '&quot; height=&quot;' + size + '&quot;>'"></textarea>
