    ...
    <form method="POST" action="{{ route('user.links.store') }}">
        ...
        <div class="glass rounded-2xl p-6 space-y-4">
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title') }}" placeholder="e.g. Jane Doe — Resume" class="w-full border border-white/10 rounded-xl px-3 py-2.5 text-sm focus:ring-2 focus:ring-violet-500/40">
        ...
        <div class="flex justify-end gap-3 mt-6">
            ...
            <button type="submit" class="px-5 py-2.5 rounded-xl text-sm font-semibold bg-violet-600 hover:bg-violet-500 text-white">Create &amp; Build Resume</button>
        </div>
    </form>
</div>
@endsection
