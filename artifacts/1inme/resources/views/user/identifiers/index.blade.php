...
<div class="max-w-3xl">
                ...
                <li class="py-3 flex items-center justify-between gap-4">
                    <div class="min-w-0">
                        <div class="flex items-center gap-2">
                            ...
                            @if($id->is_primary)
                                <span class="text-[10px] uppercase tracking-wider text-blue-200 bg-blue-500/20 border border-blue-500/30 rounded-full px-2 py-0.5">Primary</span>
                            @endif
                            @if(!$id->verified_at)
    ...
    <div class="glass rounded-2xl p-6 mb-6">
        ...
        @if($pending)
            ...
            <form method="POST" action="{{ route('user.identifiers.confirm') }}" class="flex gap-2">
                ...
                <button class="px-4 py-2.5 bg-blue-600 text-white rounded-xl font-medium hover:bg-blue-700">Verify</button>
            </form>
        @else
    ...
    <div class="glass rounded-2xl p-6 mb-6">
        ...
        <p class="text-sm text-white/60 mb-3">Connecting a social account from <a href="{{ route('user.social-accounts.index') }}" class="text-blue-300 hover:underline">Connected Accounts</a> automatically lets you sign in with it next time.</p>
    </div>
