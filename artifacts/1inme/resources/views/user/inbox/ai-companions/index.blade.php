...
<div class="max-w-4xl mx-auto px-4 py-8 space-y-4">
    <div class="flex items-end justify-between gap-3">
        ...
        <a href="{{ route('user.ai-companions.index') }}" class="text-xs px-3 py-1.5 rounded-lg bg-violet-600 hover:bg-violet-500 text-white"><i class="fas fa-cog mr-1"></i>Manage</a>
    </div>
    ...
    <div class="rounded-2xl border border-white/10 bg-white/[0.03] divide-y divide-white/5">
        ...
        @empty
            <div class="p-8 text-center text-sm text-white/40">
                ...
                <a href="{{ route('user.ai-companions.create') }}" class="text-violet-400 hover:text-violet-300 font-semibold ml-1">Create one →</a>
            </div>
        @endforelse
    </div>
</div>
