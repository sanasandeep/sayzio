    ...
    <form method="POST" action="{{ route('user.pixels.update', $pixel) }}">
        ...
        <div class="glass rounded-2xl p-6 space-y-4">
            <div>
                ...
                <input type="text" name="name" value="{{ old('name', $pixel->name) }}" class="w-full border border-white/10 rounded-xl px-3 py-2.5 text-sm focus:ring-2 focus:ring-purple-500/40 focus:border-purple-500/40" required>
            ...
            <div>
                ...
                <input type="text" name="pixel_id" value="{{ old('pixel_id', $pixel->pixel_id) }}" class="w-full border border-white/10 rounded-xl px-3 py-2.5 text-sm focus:ring-2 focus:ring-purple-500/40 focus:border-purple-500/40" required>
            </div>
        </div>
