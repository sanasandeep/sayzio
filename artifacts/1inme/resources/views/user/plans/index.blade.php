    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div class="glass rounded-2xl p-6 relative overflow-hidden group hover:shadow-lg transition-all duration-300" style="border: 1px solid var(--border-glass);">
            ...
            <div class="absolute top-3 right-3">
                <span class="px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-purple-500/20 text-purple-400">Default</span>
            </div>
            @endif

            <div class="flex items-center gap-3 mb-4">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center bg-gradient-to-br
                    {{ $plan->monthly_price == 0 ? 'from-gray-500 to-gray-600' : ($plan->monthly_price < 20 ? 'from-blue-500 to-cyan-500' : ($plan->monthly_price < 50 ? 'from-purple-500 to-violet-500' : 'from-amber-500 to-orange-500')) }}">
            ...
            <div class="mb-4 pt-3" style="border-top: 1px solid var(--border-subtle);">
                ...
                <div class="flex flex-wrap gap-1.5">
                    ...
                    @foreach(['custom_domains','qr_customization','pixels','teams','ecommerce','custom_branding'] as $fKey)
                        ...
                        <span class="px-2 py-0.5 rounded-md text-[10px] font-medium bg-purple-500/10 text-purple-400">
