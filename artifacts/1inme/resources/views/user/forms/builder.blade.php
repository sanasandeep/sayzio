                                    ...
                                    <div class="space-y-1.5">
                                        <template x-for="(po, j) in (fields[selectedIndex].price_options || [])" :key="`po-${j}`">
                                            <div class="flex items-center gap-1.5 min-w-0">
                                                <input type="text" x-model="po.label" :title="po.label" placeholder="Label" class="theme-input flex-1 min-w-0 text-xs text-ellipsis overflow-hidden">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-1.5">
                                        <template x-for="(ad, j) in (fields[selectedIndex].addons || [])" :key="`ad-${j}`">
                                            <div class="flex items-center gap-1.5 min-w-0">
                                                <input type="text" x-model="ad.label" :title="ad.label" placeholder="Label" class="theme-input flex-1 min-w-0 text-xs text-ellipsis overflow-hidden">
