...
<div class="grid grid-cols-2 md:grid-cols-5 gap-3 mb-8">
    <div class="stat-card group shimmer" style="--stat-accent: linear-gradient(90deg, #8b5cf6, #a78bfa); --stat-glow: rgba(139,92,246,0.12); --stat-border-color: rgba(139,92,246,0.2);">
        <div class="flex items-center justify-between relative z-10">
            ...
            <div class="w-10 h-10 rounded-xl flex items-center justify-center glow-icon group-hover:scale-110 transition-all duration-500" style="background: rgba(139,92,246,0.1); border: 1px solid rgba(139,92,246,0.15);">
    ...
    <div class="lg:col-span-2">
        <div class="card-premium overflow-hidden">
            <div class="flex items-center justify-between px-5 py-4" style="border-bottom: 1px solid var(--border-subtle);">
                ...
                <a href="{{ route('user.links.create') }}" class="text-[11px] text-purple-400 hover:text-purple-300 font-semibold transition-all flex items-center gap-1 hover:gap-2">
            ...
            <div class="p-12 text-center">
                <div class="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4 animate-pulse-glow" style="background: rgba(139,92,246,0.08); border: 1px solid rgba(139,92,246,0.12);">
                    <i class="fas fa-link text-xl text-purple-400"></i>
                </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="min-w-0 flex-1">
                            <div class="flex items-center gap-2 mb-0.5">
                                <span class="text-sm font-semibold truncate group-hover:text-purple-400 transition-colors" style="color: var(--text-primary);">{{ $link->title ?: $link->alias }}</span>
            ...
            <div class="px-5 py-3 text-center">
                <a href="{{ route('user.links.index') }}" class="text-xs text-purple-400 hover:text-purple-300 font-semibold transition-all inline-flex items-center gap-1 hover:gap-2">
    ...
    <div class="space-y-5">
        <div class="card-premium p-5">
            <div class="flex items-center gap-2.5 mb-4">
                <div class="w-8 h-8 rounded-xl flex items-center justify-center" style="background: rgba(139,92,246,0.1); border: 1px solid rgba(139,92,246,0.15);">
                    <i class="fas fa-bolt text-purple-400 text-xs"></i>
                </div>
            ...
            <div class="space-y-1">
                <a href="{{ route('user.links.create') }}" class="flex items-center gap-3 p-2.5 rounded-xl transition-all group hover:translate-x-1" style="background: transparent;" onmouseover="this.style.background='var(--bg-glass-input)'" onmouseout="this.style.background='transparent'">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center glow-icon transition-all duration-300" style="background: rgba(139,92,246,0.1); border: 1px solid rgba(139,92,246,0.12);">
        ...
        <div class="card-premium p-5 shimmer">
            ...
            <div class="flex items-center gap-3 mb-3">
                <div class="w-11 h-11 rounded-xl bg-gradient-to-br from-purple-500 via-violet-500 to-purple-700 flex items-center justify-center shadow-lg" style="box-shadow: 0 4px 16px rgba(139,92,246,0.3);">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="w-24 h-1.5 rounded-full overflow-hidden" style="background: var(--bg-glass-input);">
                    ...
                    @endphp
                    <div class="h-full rounded-full bg-gradient-to-r from-purple-500 via-violet-500 to-purple-400 transition-all duration-1000" style="width: {{ $pct }}%; box-shadow: 0 0 8px rgba(139,92,246,0.4);"></div>
                </div>
            </div>
        </div>
    </div>
