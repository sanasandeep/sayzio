...
<style>
    ...
    /* Localised aurora depth behind the whole dashboard grid (dark mode only). */
    ...
    /* Live pulse orb — today's clicks with a pulsing ring */
    .pulse-orb {
        position: relative;
        width: 116px;
        height: 116px;
    ...
    @media (prefers-reduced-motion: reduce) {
        .dash-tab, .dash-row, .bento-tile { transition: none; }
