...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <a href="{{ route('user.verification.admin') }}" class="text-xs font-medium transition-colors hover:text-purple-400" style="color: var(--text-muted);">
        ...
        <div class="lg:col-span-2 space-y-5">
            <div class="card-premium p-6">
                <div class="flex items-center gap-4 mb-5">
                    ...
                    @else
                    <div class="w-16 h-16 rounded-xl flex items-center justify-center" style="background: rgba(124,58,237,0.1);"><i class="fas fa-building text-purple-400 text-xl"></i></div>
                    @endif
                    <div>
                        <h2 class="text-lg font-bold" style="color: var(--text-primary);">{{ $verificationRequest->display_name }}</h2>
                        <div class="flex items-center gap-2 mt-1">
                            <span class="px-2 py-0.5 rounded-full text-[10px] font-semibold {{ $verificationRequest->category === 'artist_creator' ? 'bg-purple-500/10 text-purple-400' : 'bg-blue-500/10 text-blue-400' }}">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <a href="/{{ $verificationRequest->link->alias }}" target="_blank" class="text-[11px] text-purple-400 hover:underline">/{{ $verificationRequest->link->alias }} <i class="fas fa-external-link-alt text-[9px]"></i></a>
                        </div>
                    </div>
                    <div>
