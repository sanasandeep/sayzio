        ...
        <div class="lg:col-span-2 space-y-5">
            <div class="card-premium p-6">
                <div class="flex items-center gap-4 mb-5">
                    ...
                    @else
                    <div class="w-16 h-16 rounded-xl flex items-center justify-center" style="background: rgba(61,107,255,0.1);"><i class="fas fa-building text-blue-400 text-xl"></i></div>
                    @endif
                    <div>
