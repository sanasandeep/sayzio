...
<body class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" style="background: var(--bg-body);">
    ...
    <div class="w-full max-w-md relative z-10">
        <div class="text-center mb-8">
            ...
            <p class="text-purple-300/60 mt-2">Reset your password</p>
        </div>
        ...
        <div class="glass backdrop-blur-xl rounded-2xl p-8">
            ...
            <p class="text-sm mb-6 text-center" style="color: var(--text-muted);">Enter your email and we'll send you a reset link.</p>
