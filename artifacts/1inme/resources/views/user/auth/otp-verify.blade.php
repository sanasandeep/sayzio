...
<body class="bg-transparent min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="backdrop-blur-xl glass rounded-2xl p-8 text-center">
            ...
            <p class="theme-text-muted text-sm mb-6">We sent a 6-digit code to your {{ session('otp_type', 'email') }}</p>
            ...
            <form method="POST" action="{{ route('user.otp.verify') }}">
                ...
                <div class="mb-4">
                    <input type="text" name="code" maxlength="6" placeholder="000000" required autofocus
                           class="w-full text-center text-3xl tracking-[0.5em] font-bold px-4 py-4 bg-white/5 border border-white/10 rounded-lg theme-text-primary placeholder-gray-600 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition">
                </div>
