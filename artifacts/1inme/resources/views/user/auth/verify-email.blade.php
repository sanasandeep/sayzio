...
<body class="bg-transparent min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="backdrop-blur-xl glass rounded-2xl p-8 text-center">
            ...
            <p class="theme-text-muted text-sm mb-6">We've sent a verification link to your email. Please check your inbox and click the link to verify.</p>
            ...
            <div class="mt-4">
                <a href="{{ route('user.dashboard') }}" class="text-sm text-gray-500 hover:theme-text-muted">Skip for now</a>
            </div>
        </div>
    </div>
</body>
