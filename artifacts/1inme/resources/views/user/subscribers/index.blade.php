...
<div class="max-w-7xl mx-auto" x-data="{ deleteId: null }">
    <div class="flex items-center justify-between mb-6 flex-wrap gap-3">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('user.subscribers.compose') }}" class="px-4 py-2 rounded-xl text-sm font-medium text-white transition-all hover:-translate-y-0.5" style="background: linear-gradient(135deg, #7c3aed, #a855f7);">
    ...
    <div class="glass rounded-2xl p-4 mb-6">
        <form method="GET" class="flex flex-wrap gap-3 items-end">
            ...
            <button type="submit" class="px-4 py-2 rounded-xl text-sm font-medium text-white" style="background: linear-gradient(135deg, #7c3aed, #a855f7);">Filter</button>
    ...
    <div class="glass rounded-2xl p-12 text-center">
        ...
        <a href="{{ route('user.links.index') }}" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-medium text-white" style="background: linear-gradient(135deg, #7c3aed, #a855f7);">
