...
<div class="max-w-3xl mx-auto" x-data="{ channel: 'email' }">
    ...
    <form method="POST" action="{{ route('user.subscribers.send') }}">
            ...
            <div class="grid grid-cols-2 gap-3">
                <label class="cursor-pointer">
                    ...
                    <div class="glass rounded-xl p-4 text-center transition-all peer-checked:ring-2 peer-checked:ring-blue-500 hover:bg-white/[0.03]">
                        <div class="w-12 h-12 rounded-full mx-auto mb-2 flex items-center justify-center" style="background: linear-gradient(135deg, rgba(61,107,255,0.3), rgba(92,131,255,0.2));">
        ...
        <div class="flex items-center justify-between">
            ...
            <button type="submit" class="px-6 py-2.5 rounded-xl text-sm font-semibold text-white transition-all hover:-translate-y-0.5 flex items-center gap-2" style="background: linear-gradient(135deg, #3d6bff, #5c83ff);"
        ...
        <div class="space-y-3">
            ...
            <div class="glass rounded-xl p-4 flex items-center justify-between">
                <div class="flex items-center gap-3 min-w-0">
                    <div class="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0" style="background: {{ $msg->channel === 'email' ? 'rgba(61,107,255,0.15)' : 'rgba(37,211,102,0.15)' }};">
