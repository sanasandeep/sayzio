        ...
        <div class="glass rounded-2xl p-6 mb-6">
            ...
            <div class="grid grid-cols-2 gap-3">
                <label class="cursor-pointer">
                    ...
                    <div class="glass rounded-xl p-4 text-center transition-all peer-checked:ring-2 peer-checked:ring-violet-500 hover:bg-white/[0.03]">
                        <div class="w-12 h-12 rounded-full mx-auto mb-2 flex items-center justify-center" style="background: linear-gradient(135deg, rgba(124,58,237,0.3), rgba(139,92,246,0.2));">
                            <i class="fas fa-envelope text-violet-400 text-lg"></i>
                        </div>
            ...
            <div class="glass rounded-xl p-4 flex items-center justify-between">
                <div class="flex items-center gap-3 min-w-0">
                    <div class="w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0" style="background: {{ $msg->channel === 'email' ? 'rgba(124,58,237,0.15)' : 'rgba(37,211,102,0.15)' }};">
                        <i class="{{ $msg->channel === 'email' ? 'fas fa-envelope text-violet-400' : 'fab fa-whatsapp' }} text-sm" style="{{ $msg->channel !== 'email' ? 'color:#25D366' : '' }}"></i>
                    </div>
                    <div class="min-w-0">
