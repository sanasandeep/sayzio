...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('user.projects.create') }}" class="bg-violet-600 hover:bg-violet-700 text-white px-4 py-2 rounded-xl text-sm font-medium flex items-center gap-2">
...
<div class="glass rounded-2xl p-12 text-center">
    <div class="w-16 h-16 bg-violet-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
        <i class="fas fa-folder text-violet-400 text-2xl"></i>
    </div>
    ...
    <a href="{{ route('user.projects.create') }}" class="inline-flex items-center gap-2 bg-violet-600 hover:bg-violet-700 text-white px-4 py-2 rounded-xl text-sm font-medium">
    ...
    <div class="glass rounded-2xl p-5 hover:border-primary-200 transition-colors">
        <div class="flex items-start justify-between mb-3">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <a href="{{ route('user.projects.show', $project) }}" class="font-semibold text-white hover:text-violet-400">{{ $project->name }}</a>
