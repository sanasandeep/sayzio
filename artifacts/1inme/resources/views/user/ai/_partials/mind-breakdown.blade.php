                ...
                <div class="rounded-xl border {{ $contributed ? 'border-white/10 bg-white/[0.02]' : 'border-amber-400/30 bg-amber-400/[0.04]' }} p-3">
                    ...
                    @unless($contributed)
                        <p class="mt-2 text-xs text-amber-200/80 leading-relaxed">
                            This knowledge base didn't contribute to the answer, but you were still charged coins for embedding it.
                            Consider unchecking it in the knowledge base picker next time to save coins, or
