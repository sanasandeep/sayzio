...
@section('title', 'AI Link Optimizer')
...
<div class="max-w-3xl mx-auto px-4 py-8">
    @include('user.ai._partials.header', [
        ...
        'subtitle' => 'Pick a link, AI Link Optimizer reviews recent stats and proposes experiments.',
        'balance'  => $balance,
    ])
    ...
    @if($result)
        <div class="mt-6 rounded-2xl border border-blue-500/20 bg-blue-500/[0.05] p-5">
            <div class="flex items-center justify-between mb-2">
                <p class="text-xs text-white/40 uppercase tracking-wider">AI Link Optimizer on "{{ $result['link_title'] }}"</p>
