...
<head>
    ...
    <style>
        ...
        {{-- The section-separator and lit-surface system used to live here.
             It is shared with every marketing page now, so it lives in
             public/partials/section-surfaces.blade.php, included by this file
             and by public/layouts/site.blade.php. See that partial. --}}
