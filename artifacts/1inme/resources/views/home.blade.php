        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative min-h-[420px]">
                ...
                $catData = [
                    ...
                    ['badge' => 'FREELANCERS & AGENCIES', 'badgeBg' => '#2563eb', 'title' => 'Professional identity, simplified', 'desc' => 'Share your portfolio, generate Digital Cards for networking, and create branded link pages that impress.', 'checks' => ['Digital Cards (vCard contacts)', 'Portfolio & case study links', 'Branded Link in Bio pages for clients', 'Password-protected links'], 'checkColor' => '#2563eb', 'mockupBg' => 'from-[#2563eb] to-[#3b82f6]', 'mockupIcon' => 'fa-pen-nib', 'mockupName' => 'Alex Rivera', 'mockupSub' => 'UX Designer', 'links' => [['bg' => '#1e2330', 'text' => 'white', 'icon' => 'fas fa-briefcase', 'label' => 'View Portfolio'], ['bg' => '#2563eb', 'text' => 'white', 'icon' => 'fas fa-address-card', 'label' => 'Save Contact'], ['bg' => '#7c3aed', 'text' => 'white', 'icon' => 'fab fa-linkedin', 'label' => 'LinkedIn']]],
                    ['badge' => 'EVENT ORGANIZERS', 'badgeBg' => '#ea580c', 'title' => 'Events made effortless', 'desc' => 'Generate Event Invites, create QR codes for check-in, and share event details through a single link.', 'checks' => ['Event Invites (calendar files)', 'QR codes for event check-in', 'Ticket & RSVP Short Links', 'Expiring links for time-sensitive content'], 'checkColor' => '#ea580c', 'mockupBg' => 'from-[#ea580c] to-[#f97316]', 'mockupIcon' => 'fa-music', 'mockupName' => 'SoundWave Fest', 'mockupSub' => 'Music Festival 2026', 'links' => [['bg' => '#1e2330', 'text' => 'white', 'icon' => 'fas fa-ticket-alt', 'label' => 'Get Tickets'], ['bg' => '#ea580c', 'text' => 'white', 'icon' => 'fas fa-calendar-plus', 'label' => 'Add to Calendar'], ['bg' => '#7c3aed', 'text' => 'white', 'icon' => 'fas fa-map-marker-alt', 'label' => 'Venue & Directions']]],
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8 lg:gap-12 relative">
                ...
                <div class="reveal reveal-delay-2 text-center relative">
                    ...
                    <p class="text-white/60 text-sm leading-relaxed">Build Link in Bio pages, shorten URLs, upload files, generate QR codes, or create Digital Cards — all from one dashboard.</p>
                </div>
            ...
            <div class="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                ...
                <div class="reveal reveal-delay-2 card-hover bg-gradient-to-br from-[#7c3aed] to-[#8b5cf6] rounded-3xl p-8 relative overflow-hidden shadow-2xl shadow-[#7c3aed]/30 scale-105">
                    ...
                    <ul class="space-y-3 mb-8">
                        ...
                        <li class="flex items-center gap-2 text-sm text-white"><i class="fas fa-check text-[#8b5cf6] text-xs"></i>Tracking pixels</li>
                    </ul>
