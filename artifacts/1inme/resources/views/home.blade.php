...
<head>
    ...
    <meta name="description" content="Connect your audience to all of your content with just one link. Link in Bio pages, Short Links, file sharing, QR codes, and more.">
...
<body class="font-sans overflow-x-hidden">
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-[#1e2330]/90 backdrop-blur-xl border-b border-white/5" x-data="{ mobileOpen: false }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div x-show="mobileOpen" x-cloak x-transition class="md:hidden pb-4 border-t border-white/10 mt-2 pt-4 space-y-2">
                <a href="#use-cases" @click="mobileOpen = false" class="block px-4 py-2 text-sm text-gray-300 hover:text-[#8b5cf6] rounded-lg">Use Cases</a>
                <a href="#features" @click="mobileOpen = false" class="block px-4 py-2 text-sm text-gray-300 hover:text-[#8b5cf6] rounded-lg">Features</a>
                <a href="#how-it-works" @click="mobileOpen = false" class="block px-4 py-2 text-sm text-gray-300 hover:text-[#8b5cf6] rounded-lg">How It Works</a>
                <a href="#pricing" @click="mobileOpen = false" class="block px-4 py-2 text-sm text-gray-300 hover:text-[#8b5cf6] rounded-lg">Pricing</a>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                <div class="text-center lg:text-left">
                    <div class="reveal inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 border border-white/10 rounded-full text-[#8b5cf6] text-sm font-medium mb-6 backdrop-blur-sm">
                    ...
                    <h1 class="reveal reveal-delay-1 text-5xl sm:text-6xl lg:text-7xl font-bold leading-[1.05] tracking-tight text-white mb-6">
                        ...
                        <span class="text-[#8b5cf6]">one simple</span><br>
                        <span class="text-[#8b5cf6]">link.</span>
                    </h1>
                            ...
                            <div class="bg-gradient-to-br from-[#8b5cf6] via-[#06b6d4] to-[#7c3aed] rounded-[2rem] p-[3px] shadow-2xl shadow-[#7c3aed]/30">
                                <div class="bg-[#1e2330] rounded-[1.85rem] p-4 space-y-2.5">
                                    <div class="flex items-center gap-3 mb-1">
                                        <div class="w-12 h-12 rounded-full bg-gradient-to-br from-[#8b5cf6] via-[#06b6d4] to-[#7c3aed] p-[2px] flex-shrink-0">
                                            <div class="w-full h-full rounded-full bg-[#1e2330] flex items-center justify-center">
                                                <span class="text-[#8b5cf6] text-sm font-bold">JD</span>
                                            </div>
                                        </div>
                                        <div>
                                    ...
                                    <div class="bg-white/5 rounded-xl p-2.5 border border-white/5">
                                        ...
                                        <div class="w-full h-8 bg-gradient-to-r from-[#06b6d4]/15 via-[#7c3aed]/15 to-[#8b5cf6]/15 rounded-lg flex items-center justify-center">
                        ...
                        <div class="w-72 sm:w-80 bg-gradient-to-br {{ $cat['mockupBg'] }} rounded-[2rem] p-[3px] shadow-2xl">
                            <div class="bg-[#1e2330] rounded-[1.85rem] p-4 space-y-2">
                                ...
                                <div class="bg-white/5 rounded-lg p-1.5 border border-white/5">
                                    ...
                                    <div class="w-full h-6 bg-gradient-to-r from-[#06b6d4]/10 via-[#7c3aed]/10 to-[#8b5cf6]/10 rounded flex items-center justify-center"><span class="text-[7px] text-gray-500">Spotify / YouTube embed</span></div>
                                </div>
                            </div>
                        </div>
                        @else
                ...
                <div class="reveal reveal-delay-2 flex justify-center">
                    <div class="grid grid-cols-3 gap-3 max-w-md">
                        <div class="card-hover bg-white/15 backdrop-blur-sm rounded-2xl p-4 text-center border border-white/10">
                            <div class="text-2xl mb-1.5"><i class="fas fa-font text-[#8b5cf6]"></i></div>
                        ...
                        <div class="card-hover bg-white/15 backdrop-blur-sm rounded-2xl p-4 text-center border border-white/10 mt-4">
                            <div class="text-2xl mb-1.5"><i class="fas fa-code text-[#8b5cf6]"></i></div>
                        ...
                        <div class="card-hover bg-white/15 backdrop-blur-sm rounded-2xl p-4 text-center border border-white/10 col-span-3">
                            <div class="text-2xl mb-1.5"><i class="fas fa-columns text-[#8b5cf6]"></i></div>
                        ...
                        <div class="bg-white/15 backdrop-blur-sm rounded-3xl p-6 border border-white/10">
                            ...
                            <div class="bg-white rounded-2xl p-6 flex items-center justify-center mb-4">
                                <div class="w-36 h-36 bg-[#1e2330] rounded-xl flex items-center justify-center">
                                    <i class="fas fa-qrcode text-6xl text-[#8b5cf6]"></i>
                                </div>
                            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <a href="{{ route('user.register') }}" class="reveal reveal-delay-2 inline-flex items-center gap-2 px-8 py-4 bg-[#1e2330] text-[#8b5cf6] rounded-full text-base font-bold hover:bg-[#2a3040] transition-all hover:shadow-xl hover:-translate-y-0.5">
                        Get started for free
                    </a>
                </div>
                <div class="reveal reveal-delay-2 flex justify-center">
                    <div class="bg-[#1e2330] rounded-3xl p-6 w-full max-w-sm shadow-2xl shadow-[#1e2330]/20">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <div class="text-xs text-[#8b5cf6] font-medium bg-[#7c3aed]/10 px-2 py-1 rounded-full">Live</div>
                        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="reveal text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4">
                    Up and running in <span class="text-[#8b5cf6]">3 minutes</span>
                </h2>
                <p class="reveal reveal-delay-1 text-lg text-white/60 max-w-2xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-8 lg:gap-12 relative">
                ...
                <div class="reveal reveal-delay-2 text-center relative">
                    ...
                    <p class="text-white/60 text-sm leading-relaxed">Build Link in Bio pages, shorten URLs, upload files, generate QR codes, or create Contact Cards — all from one dashboard.</p>
                </div>
    ...
    <section id="pricing" class="py-24 lg:py-32 bg-[#1e2330]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="reveal text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4">
                    Simple, <span class="text-[#8b5cf6]">transparent</span> pricing
                </h2>
                    ...
                    <div class="reveal reveal-delay-{{ $i + 1 }} card-hover {{ $featured ? 'bg-gradient-to-br from-[#7c3aed] to-[#8b5cf6] shadow-2xl shadow-[#7c3aed]/30 scale-105 relative overflow-hidden' : 'bg-white/5 border border-white/10 backdrop-blur-sm' }} rounded-3xl p-8">
                        ...
                        @unless($plan['is_free'])
                            @if(!empty($plan['tax']))
                                ...
                                @if(!empty($plan['tax']['note']))
                                    <div class="text-[10px] italic {{ $featured ? 'text-white/60' : 'text-gray-500' }} mb-1">{{ $plan['tax']['note'] }}</div>
                                @endif
                            @else
            ...
            <div class="grid md:grid-cols-4 gap-8 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2.5">
                        <li><a href="#features" class="text-sm text-gray-500 hover:text-[#8b5cf6] transition-colors">Features</a></li>
                        <li><a href="#pricing" class="text-sm text-gray-500 hover:text-[#8b5cf6] transition-colors">Pricing</a></li>
                        <li><a href="#use-cases" class="text-sm text-gray-500 hover:text-[#8b5cf6] transition-colors">Use Cases</a></li>
                    </ul>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5">
                        @auth
                            <li><a href="{{ route('user.dashboard') }}" class="text-sm text-gray-500 hover:text-[#8b5cf6] transition-colors">Dashboard</a></li>
                            <li><a href="{{ route('user.profile.edit') }}" class="text-sm text-gray-500 hover:text-[#8b5cf6] transition-colors">Profile</a></li>
                        @else
                            <li><a href="{{ route('user.login') }}" class="text-sm text-gray-500 hover:text-[#8b5cf6] transition-colors">Log in</a></li>
                            <li><a href="{{ route('user.register') }}" class="text-sm text-gray-500 hover:text-[#8b5cf6] transition-colors">Sign up</a></li>
                        @endauth
                    </ul>
                </div>
            </div>
