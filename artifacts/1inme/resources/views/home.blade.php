...
<body class="font-sans overflow-x-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <a href="{{ route('home') }}" class="text-2xl font-bold tracking-tight">
                    <span class="text-white">1IN</span><span class="text-[#3e97ff]">ME</span>
                </a>

                <div class="hidden md:flex items-center gap-8">
                    <a href="#use-cases" class="text-sm text-gray-300 hover:text-[#3e97ff] transition-colors">Use Cases</a>
                    <a href="#features" class="text-sm text-gray-300 hover:text-[#3e97ff] transition-colors">Features</a>
                    <a href="#how-it-works" class="text-sm text-gray-300 hover:text-[#3e97ff] transition-colors">How It Works</a>
                    <a href="#pricing" class="text-sm text-gray-300 hover:text-[#3e97ff] transition-colors">Pricing</a>
                </div>

                <div class="hidden md:flex items-center gap-3">
                    @auth
                        <a href="{{ route('user.dashboard') }}" class="px-6 py-2.5 bg-[#1b84ff] text-white rounded-full text-sm font-bold hover:bg-[#0065d4] transition-all">Dashboard</a>
                    @else
                        <a href="{{ route('user.login') }}" class="px-4 py-2 text-sm font-medium text-gray-300 hover:text-white transition-colors">Log in</a>
                        <a href="{{ route('user.register') }}" class="px-6 py-2.5 bg-[#1b84ff] text-white rounded-full text-sm font-bold hover:bg-[#0065d4] transition-all">Sign up free</a>
                    @endauth
                </div>
            ...
            <div x-show="mobileOpen" x-cloak x-transition class="md:hidden pb-4 border-t border-white/10 mt-2 pt-4 space-y-2">
                <a href="#use-cases" @click="mobileOpen = false" class="block px-4 py-2 text-sm text-gray-300 hover:text-[#3e97ff] rounded-lg">Use Cases</a>
                <a href="#features" @click="mobileOpen = false" class="block px-4 py-2 text-sm text-gray-300 hover:text-[#3e97ff] rounded-lg">Features</a>
                <a href="#how-it-works" @click="mobileOpen = false" class="block px-4 py-2 text-sm text-gray-300 hover:text-[#3e97ff] rounded-lg">How It Works</a>
                <a href="#pricing" @click="mobileOpen = false" class="block px-4 py-2 text-sm text-gray-300 hover:text-[#3e97ff] rounded-lg">Pricing</a>
                <div class="pt-2 border-t border-white/10 space-y-2">
                    @auth
                        <a href="{{ route('user.dashboard') }}" class="block px-4 py-2.5 bg-[#1b84ff] text-white rounded-lg text-sm font-bold text-center">Dashboard</a>
                    @else
                        <a href="{{ route('user.login') }}" class="block px-4 py-2 text-sm text-gray-300">Log in</a>
                        <a href="{{ route('user.register') }}" class="block px-4 py-2.5 bg-[#1b84ff] text-white rounded-lg text-sm font-bold text-center">Sign up free</a>
                    @endauth
                </div>
            </div>
        </div>
    ...
    <section class="relative min-h-screen bg-[#1e2330] pt-28 pb-20 lg:pt-36 lg:pb-28 overflow-hidden">
        <div class="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] bg-[#1b84ff] rounded-full mix-blend-screen filter blur-[120px] opacity-30 blob-spin"></div>
        ...
        <div class="absolute bottom-[20%] left-[15%] w-[300px] h-[300px] bg-[#1b84ff] rounded-full mix-blend-screen filter blur-[80px] opacity-15 blob-spin" style="animation-delay: -18s;"></div>

        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                <div class="text-center lg:text-left">
                    <div class="reveal inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 border border-white/10 rounded-full text-[#3e97ff] text-sm font-medium mb-6 backdrop-blur-sm">
                        <span class="relative flex h-2 w-2"><span class="absolute inline-flex h-full w-full rounded-full bg-[#1b84ff] opacity-75 animate-ping"></span><span class="relative inline-flex rounded-full h-2 w-2 bg-[#1b84ff]"></span></span>
                    ...
                    <h1 class="reveal reveal-delay-1 text-5xl sm:text-6xl lg:text-7xl font-bold leading-[1.05] tracking-tight text-white mb-6">
                        ...
                        <span class="text-[#3e97ff]">one simple</span><br>
                        <span class="text-[#3e97ff]">link.</span>
                    </h1>
                    ...
                    <div class="reveal reveal-delay-3 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                        <a href="{{ route('user.register') }}" class="px-8 py-4 bg-[#1b84ff] text-white rounded-full text-base font-bold hover:bg-[#0065d4] transition-all hover:shadow-xl hover:shadow-[#1b84ff]/20 hover:-translate-y-0.5">
                    ...
                    <div class="reveal reveal-delay-4 flex items-center gap-6 mt-8 justify-center lg:justify-start text-sm text-gray-500">
                        <span class="flex items-center gap-1.5"><i class="fas fa-check text-[#3e97ff]"></i> Free forever plan</span>
                        <span class="flex items-center gap-1.5"><i class="fas fa-check text-[#3e97ff]"></i> No credit card</span>
                    </div>
                </div>
                ...
                <div class="reveal reveal-delay-3 relative flex justify-center lg:justify-end">
                    <div class="relative w-[310px] sm:w-[360px]">
                        <div class="hero-float">
                            <div class="bg-gradient-to-br from-[#3e97ff] via-[#06b6d4] to-[#1b84ff] rounded-[2rem] p-[3px] shadow-2xl shadow-[#1b84ff]/30">
                                <div class="bg-[#1e2330] rounded-[1.85rem] p-4 space-y-2.5">
                                    <div class="flex items-center gap-3 mb-1">
                                        <div class="w-12 h-12 rounded-full bg-gradient-to-br from-[#3e97ff] via-[#06b6d4] to-[#1b84ff] p-[2px] flex-shrink-0">
                                            <div class="w-full h-full rounded-full bg-[#1e2330] flex items-center justify-center">
                                                <span class="text-[#3e97ff] text-sm font-bold">JD</span>
                                            </div>
                                        </div>
                                        <div>
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class="bg-gradient-to-br from-[#1b84ff]/30 to-[#1b84ff]/10 rounded-xl p-2.5 border border-[#1b84ff]/20">
                                            <div class="w-full aspect-video bg-[#1b84ff]/20 rounded-lg flex items-center justify-center mb-1.5">
                                                <div class="w-7 h-7 rounded-full bg-[#1b84ff] flex items-center justify-center"><i class="fas fa-play text-white text-[8px] ml-0.5"></i></div>
                                            </div>
                                        ...
                                        <div class="bg-gradient-to-br from-[#06b6d4]/30 to-[#06b6d4]/10 rounded-xl p-2.5 border border-[#06b6d4]/20">
                                            <div class="w-full aspect-video bg-[#06b6d4]/20 rounded-lg flex items-center justify-center mb-1.5 overflow-hidden">
                                                <div class="grid grid-cols-2 gap-0.5 w-full h-full p-1">
                                                    ...
                                                    <div class="bg-[#1b84ff]/30 rounded"></div>
                                    ...
                                    <div class="bg-white/5 rounded-xl p-2.5 border border-white/5 flex items-center gap-3">
                                        ...
                                        <div class="flex items-end gap-[2px] h-4">
                                            <div class="w-[3px] bg-[#1b84ff] rounded-full animate-pulse" style="height: 40%"></div>
                                            <div class="w-[3px] bg-[#1b84ff] rounded-full animate-pulse" style="height: 80%; animation-delay: 0.15s"></div>
                                            <div class="w-[3px] bg-[#1b84ff] rounded-full animate-pulse" style="height: 55%; animation-delay: 0.3s"></div>
                                            <div class="w-[3px] bg-[#1b84ff] rounded-full animate-pulse" style="height: 90%; animation-delay: 0.1s"></div>
                                        </div>
                                    </div>

                                    <div class="grid grid-cols-2 gap-2">
                                        <a class="block py-2.5 px-3 bg-[#1b84ff] text-white rounded-xl text-[11px] font-bold text-center">
                                    ...
                                    <div class="bg-white/5 rounded-xl p-2.5 border border-white/5">
                                        ...
                                        <div class="w-full h-8 bg-gradient-to-r from-[#06b6d4]/15 via-[#1b84ff]/15 to-[#3e97ff]/15 rounded-lg flex items-center justify-center">
                        ...
                        <div class="hero-float-2 absolute -top-3 -right-6 bg-[#1b84ff] rounded-2xl shadow-xl shadow-[#1b84ff]/20 p-2.5 flex items-center gap-2">
                        ...
                        <div class="hero-float absolute -bottom-4 -left-6 bg-[#1b84ff] rounded-2xl shadow-xl shadow-[#1b84ff]/30 p-2.5 flex items-center gap-2">
    ...
    <div class="bg-[#1b84ff] py-4 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="reveal text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-[#1e2330] mb-4">
                    Built for <span class="text-[#1b84ff]">every</span> business
                </h2>
            ...
            <div class="reveal reveal-delay-2 flex flex-wrap justify-center gap-2 mb-14">
                @php
                $categories = [
                    ['icon' => 'fa-palette', 'label' => 'Creators', 'bg' => '#1b84ff', 'text' => '#fff'],
                        ...
                        <div class="w-72 sm:w-80 bg-gradient-to-br {{ $cat['mockupBg'] }} rounded-[2rem] p-[3px] shadow-2xl">
                            <div class="bg-[#1e2330] rounded-[1.85rem] p-4 space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-1.5">
                                    <div class="bg-[#1b84ff]/20 rounded-lg p-2 border border-[#1b84ff]/15">
                                        <div class="w-full aspect-video bg-[#1b84ff]/25 rounded flex items-center justify-center mb-1"><div class="w-5 h-5 rounded-full bg-[#1b84ff] flex items-center justify-center"><i class="fas fa-play text-white text-[6px] ml-px"></i></div></div>
                                    ...
                                    <div class="bg-[#06b6d4]/20 rounded-lg p-2 border border-[#06b6d4]/15">
                                        <div class="w-full aspect-video bg-[#06b6d4]/25 rounded overflow-hidden mb-1"><div class="grid grid-cols-2 gap-px w-full h-full p-0.5"><div class="bg-[#06b6d4]/30 rounded-sm"></div><div class="bg-[#1b84ff]/30 rounded-sm"></div><div class="bg-[#f43f5e]/30 rounded-sm"></div><div class="bg-[#1b84ff]/30 rounded-sm"></div></div></div>
                                ...
                                <div class="bg-white/5 rounded-lg p-2 border border-white/5 flex items-center gap-2">
                                    ...
                                    <div class="flex items-end gap-[1.5px] h-3"><div class="w-[2px] bg-[#1b84ff] rounded-full animate-pulse" style="height:35%"></div><div class="w-[2px] bg-[#1b84ff] rounded-full animate-pulse" style="height:75%;animation-delay:.15s"></div><div class="w-[2px] bg-[#1b84ff] rounded-full animate-pulse" style="height:50%;animation-delay:.3s"></div><div class="w-[2px] bg-[#1b84ff] rounded-full animate-pulse" style="height:85%;animation-delay:.1s"></div></div>
                                </div>
                                <div class="grid grid-cols-2 gap-1.5">
                                    <div class="py-2 rounded-lg text-[10px] font-bold text-center bg-[#1b84ff] text-white"><i class="fas fa-download mr-1"></i>Free Kit</div>
                                ...
                                <div class="bg-white/5 rounded-lg p-1.5 border border-white/5">
                                    ...
                                    <div class="w-full h-6 bg-gradient-to-r from-[#06b6d4]/10 via-[#1b84ff]/10 to-[#3e97ff]/10 rounded flex items-center justify-center"><span class="text-[7px] text-gray-500">Spotify / YouTube embed</span></div>
                                </div>
                            </div>
                        </div>
                        @else
            ...
            <div class="flex justify-center gap-2 mt-12">
                @for($i = 0; $i < 6; $i++)
                <button @click="active = {{ $i }}; auto = false" :class="active === {{ $i }} ? 'w-10' : 'w-2.5'" class="h-2.5 rounded-full transition-all duration-500" :style="active === {{ $i }} ? 'background-color: #1b84ff' : 'background-color: #1e233040'"></button>
                @endfor
            </div>
        </div>
    </section>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <a href="{{ route('user.register') }}" class="reveal reveal-delay-2 inline-flex items-center gap-2 px-8 py-4 bg-[#1b84ff] text-white rounded-full text-base font-bold hover:bg-[#0065d4] transition-all hover:shadow-xl hover:-translate-y-0.5">
                        Get started for free
                    </a>
                </div>
                <div class="reveal reveal-delay-2 flex justify-center">
                    <div class="grid grid-cols-3 gap-3 max-w-md">
                        <div class="card-hover bg-white/15 backdrop-blur-sm rounded-2xl p-4 text-center border border-white/10">
                            <div class="text-2xl mb-1.5"><i class="fas fa-font text-[#3e97ff]"></i></div>
                        ...
                        <div class="card-hover bg-white/15 backdrop-blur-sm rounded-2xl p-4 text-center border border-white/10">
                            <div class="text-2xl mb-1.5"><i class="fas fa-video text-[#1b84ff]"></i></div>
                        ...
                        <div class="card-hover bg-white/15 backdrop-blur-sm rounded-2xl p-4 text-center border border-white/10 mt-4">
                            <div class="text-2xl mb-1.5"><i class="fas fa-code text-[#3e97ff]"></i></div>
                        ...
                        <div class="card-hover bg-white/15 backdrop-blur-sm rounded-2xl p-4 text-center border border-white/10 col-span-3">
                            <div class="text-2xl mb-1.5"><i class="fas fa-columns text-[#3e97ff]"></i></div>
                    ...
                    <div class="w-72 sm:w-80">
                        <div class="bg-white/15 backdrop-blur-sm rounded-3xl p-6 border border-white/10">
                            <div class="flex items-center gap-3 mb-6">
                                <div class="w-10 h-10 rounded-full bg-[#1b84ff] flex items-center justify-center"><i class="fas fa-qrcode text-white"></i></div>
                                <div>
                            ...
                            <div class="bg-white rounded-2xl p-6 flex items-center justify-center mb-4">
                                <div class="w-36 h-36 bg-[#1e2330] rounded-xl flex items-center justify-center">
                                    <i class="fas fa-qrcode text-6xl text-[#3e97ff]"></i>
                                </div>
                            </div>
                            <div class="flex gap-2">
                                <div class="flex-1 py-2 bg-[#1b84ff] text-white rounded-lg text-xs font-bold text-center">Download PNG</div>
    ...
    <section class="py-24 lg:py-32 bg-[#1b84ff]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 class="reveal text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                    ...
                    <a href="{{ route('user.register') }}" class="reveal reveal-delay-2 inline-flex items-center gap-2 px-8 py-4 bg-[#1e2330] text-[#3e97ff] rounded-full text-base font-bold hover:bg-[#2a3040] transition-all hover:shadow-xl hover:-translate-y-0.5">
                        Get started for free
                    </a>
                </div>
                <div class="reveal reveal-delay-2 flex justify-center">
                    <div class="bg-[#1e2330] rounded-3xl p-6 w-full max-w-sm shadow-2xl shadow-[#1e2330]/20">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <div class="text-xs text-[#3e97ff] font-medium bg-[#1b84ff]/10 px-2 py-1 rounded-full">Live</div>
                        </div>
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex-1 bg-white/5 rounded-full h-3 overflow-hidden"><div class="h-full rounded-full bg-[#1b84ff]" style="width: 78%"></div></div>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex-1 bg-white/5 rounded-full h-3 overflow-hidden"><div class="h-full rounded-full bg-[#1b84ff]" style="width: 31%"></div></div>
            ...
            <div class="overflow-hidden py-4">
                <div class="flex whitespace-nowrap marquee" style="animation-duration: 20s;">
                    ...
                    <span class="inline-flex items-center gap-6 mx-6">
                        <span class="text-4xl sm:text-5xl font-bold text-[#1b84ff]">creators</span>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="reveal text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4">
                    Up and running in <span class="text-[#3e97ff]">3 minutes</span>
                </h2>
                <p class="reveal reveal-delay-1 text-lg text-white/60 max-w-2xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-8 lg:gap-12 relative">
                ...
                <div class="reveal reveal-delay-1 text-center relative">
                    <div class="w-20 h-20 mx-auto bg-[#1b84ff] rounded-2xl flex items-center justify-center text-white text-3xl font-bold mb-6 shadow-lg shadow-[#1b84ff]/20 relative z-10 rotate-3 hover:rotate-0 transition-transform">1</div>
                ...
                <div class="reveal reveal-delay-2 text-center relative">
                    <div class="w-20 h-20 mx-auto bg-[#1b84ff] rounded-2xl flex items-center justify-center text-white text-3xl font-bold mb-6 shadow-lg shadow-[#1b84ff]/30 relative z-10 -rotate-2 hover:rotate-0 transition-transform">2</div>
            ...
            <div class="reveal reveal-delay-4 text-center mt-14">
                <a href="{{ route('user.register') }}" class="inline-flex items-center gap-2 px-8 py-4 bg-[#1b84ff] text-white rounded-full text-base font-bold hover:bg-[#0065d4] transition-all hover:shadow-xl hover:-translate-y-0.5">
    ...
    <section id="pricing" class="py-24 lg:py-32 bg-[#1e2330]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="reveal text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4">
                    Simple, <span class="text-[#3e97ff]">transparent</span> pricing
                </h2>
            ...
            <div class="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                <div class="reveal reveal-delay-1 card-hover bg-white/5 rounded-3xl p-8 border border-white/10 backdrop-blur-sm">
                    ...
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center gap-2 text-sm text-gray-300"><i class="fas fa-check text-[#3e97ff] text-xs"></i>Up to 10 links</li>
                        <li class="flex items-center gap-2 text-sm text-gray-300"><i class="fas fa-check text-[#3e97ff] text-xs"></i>Basic analytics</li>
                        <li class="flex items-center gap-2 text-sm text-gray-300"><i class="fas fa-check text-[#3e97ff] text-xs"></i>QR code generation</li>
                        <li class="flex items-center gap-2 text-sm text-gray-300"><i class="fas fa-check text-[#3e97ff] text-xs"></i>5MB file uploads</li>
                    </ul>
                ...
                <div class="reveal reveal-delay-2 card-hover bg-gradient-to-br from-[#1b84ff] to-[#3e97ff] rounded-3xl p-8 relative overflow-hidden shadow-2xl shadow-[#1b84ff]/30 scale-105">
                    <div class="absolute top-4 right-4 px-3 py-1 bg-[#1b84ff] text-white text-xs font-bold rounded-full">POPULAR</div>
                    ...
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center gap-2 text-sm text-white"><i class="fas fa-check text-[#3e97ff] text-xs"></i>Unlimited links</li>
                        <li class="flex items-center gap-2 text-sm text-white"><i class="fas fa-check text-[#3e97ff] text-xs"></i>Advanced analytics</li>
                        <li class="flex items-center gap-2 text-sm text-white"><i class="fas fa-check text-[#3e97ff] text-xs"></i>Custom domains</li>
                        <li class="flex items-center gap-2 text-sm text-white"><i class="fas fa-check text-[#3e97ff] text-xs"></i>50MB file uploads</li>
                        <li class="flex items-center gap-2 text-sm text-white"><i class="fas fa-check text-[#3e97ff] text-xs"></i>Tracking pixels</li>
                    </ul>
                    <a href="{{ route('user.register') }}" class="block w-full py-3.5 text-center bg-[#1b84ff] text-white rounded-full text-sm font-bold hover:bg-[#0065d4] transition-all">Start free trial</a>
                </div>
                ...
                <div class="reveal reveal-delay-3 card-hover bg-white/5 rounded-3xl p-8 border border-white/10 backdrop-blur-sm">
                    ...
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center gap-2 text-sm text-gray-300"><i class="fas fa-check text-[#3e97ff] text-xs"></i>Everything in Pro</li>
                        <li class="flex items-center gap-2 text-sm text-gray-300"><i class="fas fa-check text-[#3e97ff] text-xs"></i>Team collaboration</li>
                        <li class="flex items-center gap-2 text-sm text-gray-300"><i class="fas fa-check text-[#3e97ff] text-xs"></i>200MB file uploads</li>
                        <li class="flex items-center gap-2 text-sm text-gray-300"><i class="fas fa-check text-[#3e97ff] text-xs"></i>API access</li>
                        <li class="flex items-center gap-2 text-sm text-gray-300"><i class="fas fa-check text-[#3e97ff] text-xs"></i>Priority support</li>
                    </ul>
                    <a href="{{ route('user.register') }}" class="block w-full py-3.5 text-center text-white rounded-full text-sm font-bold border-2 border-white/20 hover:border-white/40 hover:bg-white/5 transition-all">Get started</a>
                </div>
            </div>
    ...
    <section class="py-24 lg:py-32 bg-[#059669] relative overflow-hidden">
        <div class="absolute top-0 right-0 w-96 h-96 bg-[#1b84ff] rounded-full mix-blend-soft-light filter blur-[100px] opacity-30"></div>
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="{{ route('user.register') }}" class="reveal reveal-delay-2 inline-flex items-center gap-2 px-10 py-5 bg-[#1b84ff] text-white rounded-full text-lg font-bold hover:bg-[#0065d4] transition-all hover:shadow-xl hover:-translate-y-1">
            ...
            <div class="grid md:grid-cols-4 gap-8 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2.5">
                        <li><a href="#features" class="text-sm text-gray-500 hover:text-[#3e97ff] transition-colors">Features</a></li>
                        <li><a href="#pricing" class="text-sm text-gray-500 hover:text-[#3e97ff] transition-colors">Pricing</a></li>
                        <li><a href="#use-cases" class="text-sm text-gray-500 hover:text-[#3e97ff] transition-colors">Use Cases</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="text-sm font-bold text-gray-400 uppercase tracking-wide mb-4">Tools</h4>
                    <ul class="space-y-2.5">
                        <li><a href="{{ route('user.register') }}" class="text-sm text-gray-500 hover:text-[#3e97ff] transition-colors">URL Shortener</a></li>
                        <li><a href="{{ route('user.register') }}" class="text-sm text-gray-500 hover:text-[#3e97ff] transition-colors">Bio Link Builder</a></li>
                        <li><a href="{{ route('user.register') }}" class="text-sm text-gray-500 hover:text-[#3e97ff] transition-colors">QR Generator</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-2.5">
                        @auth
                            <li><a href="{{ route('user.dashboard') }}" class="text-sm text-gray-500 hover:text-[#3e97ff] transition-colors">Dashboard</a></li>
                            <li><a href="{{ route('user.profile.edit') }}" class="text-sm text-gray-500 hover:text-[#3e97ff] transition-colors">Profile</a></li>
                        @else
                            <li><a href="{{ route('user.login') }}" class="text-sm text-gray-500 hover:text-[#3e97ff] transition-colors">Log in</a></li>
                            <li><a href="{{ route('user.register') }}" class="text-sm text-gray-500 hover:text-[#3e97ff] transition-colors">Sign up</a></li>
                        @endauth
                    </ul>
                </div>
            </div>
