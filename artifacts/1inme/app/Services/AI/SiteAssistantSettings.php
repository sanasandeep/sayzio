...
P;
     ...
     *
     * SINGLE SOURCE OF TRUTH for the default assistant mascot. Front-ends
     * resolve their avatar from the `avatar_url` this returns via the
     * /assistant/bootstrap payload (the Laravel blade widget fetches it on
     * mount). Change the mascot here / via the admin avatar upload and the
     * surface updates — no client edit needed.
     */
