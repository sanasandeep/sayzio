...
class BiolinkWizardQuestions
{
    ...
    public static function categories(): array
    {
        return [
            ...
            ['slug' => 'health_wellness', 'label' => 'Health & Wellness', 'icon' => 'fa-heart-pulse',   'blurb' => 'Fitness, yoga, therapy and nutrition — bookings and programs.'],
            ['slug' => 'nonprofit',   'label' => 'Nonprofit / Charity',   'icon' => 'fa-hand-holding-heart', 'blurb' => 'Mission, donations, volunteers and impact in one place.'],
            ['slug' => 'fashion_beauty', 'label' => 'Fashion & Beauty',   'icon' => 'fa-shirt',         'blurb' => 'Brands, makeup artists, models and stylists — shop and book.'],
            ['slug' => 'photographer','label' => 'Photo / Video',         'icon' => 'fa-camera',        'blurb' => 'Portfolio, showreel, packages and a booking link.'],
            ['slug' => 'travel_creator','label' => 'Travel Creator',      'icon' => 'fa-plane',         'blurb' => 'Blog, videos, trips and gear for your followers.'],
            ['slug' => 'faith',       'label' => 'Community / Faith',     'icon' => 'fa-place-of-worship', 'blurb' => 'Church, ministry or group — services, giving and events.'],
            ['slug' => 'education',   'label' => 'Education / School',     'icon' => 'fa-graduation-cap','blurb' => 'Tutors, schools, courses and teachers — enrol and learn.'],
        ];
    }
    ...
    public static function pageTypes(string $category): array
    {
        $map = [
            ...
            'health_wellness' => [
                ['slug' => 'fitness_trainer','label' => 'Personal Trainer',    'blurb' => 'Programs, free intro session, transformations.'],
                ['slug' => 'yoga',           'label' => 'Yoga / Pilates',      'blurb' => 'Class schedule, online classes, bookings.'],
                ['slug' => 'therapist',      'label' => 'Therapist / Counselor','blurb' => 'Focus areas, rates and a booking link.'],
                ['slug' => 'nutritionist',   'label' => 'Nutritionist / Dietitian','blurb' => 'Programs, free consult, meal plans.'],
            ],
            'nonprofit' => [
                ['slug' => 'charity',          'label' => 'Charity / Foundation','blurb' => 'Mission, donate button, volunteer signup.'],
                ['slug' => 'community_org',    'label' => 'Community Org',       'blurb' => 'Join, events, volunteer and donate.'],
                ['slug' => 'social_enterprise','label' => 'Social Enterprise',   'blurb' => 'Mission, shop, impact and partners.'],
                ['slug' => 'activist',         'label' => 'Cause / Campaign',    'blurb' => 'Petition, donate and get involved.'],
            ],
            'fashion_beauty' => [
                ['slug' => 'fashion_brand', 'label' => 'Fashion Brand',        'blurb' => 'Shop, lookbook, discount and newsletter.'],
                ['slug' => 'beauty_artist', 'label' => 'Makeup Artist',        'blurb' => 'Portfolio, bookings, pricing and socials.'],
                ['slug' => 'model',         'label' => 'Model',                'blurb' => 'Portfolio, agency and casting contact.'],
                ['slug' => 'stylist',       'label' => 'Stylist',              'blurb' => 'Sessions, lookbook and shop my picks.'],
                ['slug' => 'salon',         'label' => 'Salon / Spa',          'blurb' => 'Services, hours, booking and reviews.'],
            ],
            'photographer' => [
                ['slug' => 'photographer',        'label' => 'Photographer',        'blurb' => 'Portfolio, galleries, pricing and bookings.'],
                ['slug' => 'videographer',        'label' => 'Videographer',        'blurb' => 'Showreel, portfolio and a booking link.'],
                ['slug' => 'wedding_photographer','label' => 'Wedding Photographer','blurb' => 'Galleries, packages and check-your-date.'],
                ['slug' => 'studio',              'label' => 'Photo / Video Studio','blurb' => 'Services, location, portfolio and bookings.'],
            ],
            'travel_creator' => [
                ['slug' => 'travel_blogger', 'label' => 'Travel Blogger / Vlogger','blurb' => 'Blog, videos, gear and brand collabs.'],
                ['slug' => 'travel_agent',   'label' => 'Travel Agent / Planner',  'blurb' => 'Plan a trip, featured trips and contact.'],
                ['slug' => 'tour_guide',     'label' => 'Tour Guide / Local',      'blurb' => 'Book a tour, location and WhatsApp.'],
                ['slug' => 'digital_nomad',  'label' => 'Digital Nomad',           'blurb' => 'Current location, blog, gear and newsletter.'],
            ],
            'faith' => [
                ['slug' => 'church',          'label' => 'Church / Congregation','blurb' => 'Service times, give, events and watch live.'],
                ['slug' => 'faith_leader',    'label' => 'Pastor / Faith Leader','blurb' => 'Sermons, writings, giving and socials.'],
                ['slug' => 'community_group',  'label' => 'Community / Meetup',  'blurb' => 'Join, meeting info and events.'],
                ['slug' => 'mosque_temple',    'label' => 'Mosque / Temple',     'blurb' => 'Service times, donate, events and location.'],
            ],
            'education' => [
                ['slug' => 'tutor',         'label' => 'Tutor / Private Teacher','blurb' => 'Subjects, levels, rate and bookings.'],
                ['slug' => 'school',        'label' => 'School / Institution',   'blurb' => 'Admissions, programs, events and contact.'],
                ['slug' => 'online_course', 'label' => 'Online Course / Educator','blurb' => 'Enrol, curriculum, preview and price.'],
                ['slug' => 'teacher',       'label' => 'Teacher / Professor',    'blurb' => 'Resources, syllabus and office hours.'],
            ],
        ];
        return $map[$category] ?? [];
    }
    ...
    public static function industries(string $category, string $pageType): array
    {
        $map = [
            ...
            'fashion_beauty.fashion_brand' => [
                ...
                ['slug' => 'luxury',       'label' => 'Luxury / Designer'],
                ['slug' => 'sustainable',  'label' => 'Sustainable / Ethical'],
                ['slug' => 'jewelry',      'label' => 'Jewelry / Accessories'],
                ['slug' => 'beauty',       'label' => 'Beauty / Skincare'],
                ['slug' => 'other',        'label' => 'Something else'],
            ],
        ];
    ...
    public static function questions(string $category, string $pageType, ?string $industry = null): array
    {
        ...
        $byCombo = [
            ...
            // ── Health & Wellness ───────────────────────────────────────
            'health_wellness.fitness_trainer' => array_merge($base, [
                ['key' => 'specialty',      'label' => 'Specialty (1 line)', 'type' => 'text', 'placeholder' => 'Strength training for busy parents'],
                ['key' => 'program_1',      'label' => 'Program #1 name',    'type' => 'text'],
                ['key' => 'program_1_price','label' => 'Program #1 price',   'type' => 'text', 'placeholder' => '$149 / month'],
                ['key' => 'program_2',      'label' => 'Program #2 name',    'type' => 'text'],
                ['key' => 'program_2_price','label' => 'Program #2 price',   'type' => 'text'],
                ['key' => 'free_intro_url', 'label' => 'Free intro session URL', 'type' => 'url'],
                ['key' => 'booking_url',    'label' => 'Booking / signup URL','type' => 'url'],
                ['key' => 'testimonial',    'label' => 'Best client quote',  'type' => 'textarea'],
                ['key' => 'testimonial_name','label' => 'Quote — client name','type' => 'text'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),
            'health_wellness.yoga' => array_merge($base, [
                ['key' => 'style',          'label' => 'Style (Vinyasa, Hatha…)', 'type' => 'text'],
                ['key' => 'schedule',       'label' => 'Class schedule',     'type' => 'textarea', 'placeholder' => "Mon 7am · Vinyasa\nWed 6pm · Restorative"],
                ['key' => 'booking_url',    'label' => 'Class booking URL',  'type' => 'url'],
                ['key' => 'class_pass_url', 'label' => 'Online classes / membership URL', 'type' => 'url'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'youtube',        'label' => 'YouTube channel URL','type' => 'url'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),
            'health_wellness.therapist' => array_merge($base, [
                ['key' => 'credentials',    'label' => 'Credentials',        'type' => 'text', 'placeholder' => 'LMFT, PhD'],
                ['key' => 'specialties',    'label' => 'Areas of focus',     'type' => 'text', 'placeholder' => 'Anxiety, relationships, trauma'],
                ['key' => 'mode',           'label' => 'In-person, online or both?', 'type' => 'select', 'options' => [['v'=>'online','l'=>'Online'], ['v'=>'in_person','l'=>'In-person'], ['v'=>'both','l'=>'Both']]],
                ['key' => 'rates',          'label' => 'Session rate',       'type' => 'text', 'placeholder' => '$120 / 50-min session'],
                ['key' => 'booking_url',    'label' => 'Book a session URL', 'type' => 'url'],
                ['key' => 'phone',          'label' => 'Phone number',       'type' => 'phone'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email', 'required' => true],
            ]),
            'health_wellness.nutritionist' => array_merge($base, [
                ['key' => 'specialty',      'label' => 'Specialty (1 line)', 'type' => 'text', 'placeholder' => 'Gut health & sports nutrition'],
                ['key' => 'program_1',      'label' => 'Program #1 name',    'type' => 'text'],
                ['key' => 'program_1_price','label' => 'Program #1 price',   'type' => 'text'],
                ['key' => 'program_2',      'label' => 'Program #2 name',    'type' => 'text'],
                ['key' => 'program_2_price','label' => 'Program #2 price',   'type' => 'text'],
                ['key' => 'consult_url',    'label' => 'Free consultation URL', 'type' => 'url'],
                ['key' => 'plan_url',       'label' => 'Meal plans / shop URL', 'type' => 'url'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),

            // ── Nonprofit / Charity ─────────────────────────────────────
            'nonprofit.charity' => array_merge($base, [
                ['key' => 'mission',        'label' => 'Mission (2 sentences)', 'type' => 'textarea', 'required' => true],
                ['key' => 'donate_url',     'label' => 'Donation URL',       'type' => 'url'],
                ['key' => 'volunteer_form', 'label' => 'Volunteer form URL', 'type' => 'url'],
                ['key' => 'impact_blurb',   'label' => 'Impact stat (1 line)', 'type' => 'text', 'placeholder' => '12,000 meals served in 2025'],
                ['key' => 'event_url',      'label' => 'Upcoming event / fundraiser URL', 'type' => 'url'],
                ['key' => 'contact_email',  'label' => 'Contact email',      'type' => 'email'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
            ]),
            'nonprofit.community_org' => array_merge($base, [
                ['key' => 'mission',        'label' => 'What we do (2 sentences)', 'type' => 'textarea', 'required' => true],
                ['key' => 'join_url',       'label' => 'Join / membership URL', 'type' => 'url'],
                ['key' => 'event_url',      'label' => 'Events / calendar URL', 'type' => 'url'],
                ['key' => 'volunteer_form', 'label' => 'Volunteer form URL', 'type' => 'url'],
                ['key' => 'donate_url',     'label' => 'Donation URL',       'type' => 'url'],
                ['key' => 'contact_email',  'label' => 'Contact email',      'type' => 'email'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
            ]),
            'nonprofit.social_enterprise' => array_merge($base, [
                ['key' => 'mission',        'label' => 'Mission (2 sentences)', 'type' => 'textarea', 'required' => true],
                ['key' => 'store_url',      'label' => 'Shop URL',           'type' => 'url'],
                ['key' => 'impact_blurb',   'label' => 'Impact stat (1 line)', 'type' => 'text'],
                ['key' => 'partner_url',    'label' => 'Partner with us URL','type' => 'url'],
                ['key' => 'donate_url',     'label' => 'Donation URL',       'type' => 'url'],
                ['key' => 'contact_email',  'label' => 'Contact email',      'type' => 'email'],
            ]),
            'nonprofit.activist' => array_merge($base, [
                ['key' => 'cause',          'label' => 'The cause (1 line)', 'type' => 'text', 'required' => true],
                ['key' => 'petition_url',   'label' => 'Sign the petition URL', 'type' => 'url'],
                ['key' => 'donate_url',     'label' => 'Donation URL',       'type' => 'url'],
                ['key' => 'volunteer_form', 'label' => 'Get involved URL',   'type' => 'url'],
                ['key' => 'event_url',      'label' => 'Upcoming action / event URL', 'type' => 'url'],
                ['key' => 'contact_email',  'label' => 'Contact email',      'type' => 'email'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
            ]),

            // ── Fashion & Beauty ────────────────────────────────────────
            'fashion_beauty.fashion_brand' => array_merge($base, [
                ['key' => 'store_url',      'label' => 'Shop URL',           'type' => 'url', 'required' => true],
                ['key' => 'lookbook_url',   'label' => 'Lookbook / collection URL', 'type' => 'url'],
                ['key' => 'discount_code',  'label' => 'Discount code (optional)', 'type' => 'text', 'placeholder' => 'WELCOME10'],
                ['key' => 'discount_blurb', 'label' => 'Discount blurb',     'type' => 'text', 'placeholder' => 'Get 10% off your first order'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'tiktok',         'label' => 'TikTok username',    'type' => 'text'],
                ['key' => 'newsletter_blurb','label' => 'Newsletter pitch',  'type' => 'text'],
                ['key' => 'contact_email',  'label' => 'Contact email',      'type' => 'email'],
            ]),
            'fashion_beauty.beauty_artist' => array_merge($base, [
                ['key' => 'specialty',      'label' => 'Specialty (1 line)', 'type' => 'text', 'placeholder' => 'Bridal & editorial makeup'],
                ['key' => 'booking_url',    'label' => 'Booking URL',        'type' => 'url'],
                ['key' => 'portfolio_url',  'label' => 'Portfolio / gallery URL', 'type' => 'url'],
                ['key' => 'price_blurb',    'label' => 'Starting price',     'type' => 'text', 'placeholder' => 'Bridal from $250'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'tiktok',         'label' => 'TikTok username',    'type' => 'text'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),
            'fashion_beauty.model' => array_merge($base, [
                ['key' => 'agency',         'label' => 'Agency (if any)',    'type' => 'text'],
                ['key' => 'portfolio_url',  'label' => 'Portfolio URL',      'type' => 'url'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'tiktok',         'label' => 'TikTok username',    'type' => 'text'],
                ['key' => 'booking_email',  'label' => 'Booking / casting email', 'type' => 'email'],
            ]),
            'fashion_beauty.stylist' => array_merge($base, [
                ['key' => 'specialty',      'label' => 'Specialty (1 line)', 'type' => 'text', 'placeholder' => 'Personal styling & wardrobe edits'],
                ['key' => 'booking_url',    'label' => 'Book a styling session URL', 'type' => 'url'],
                ['key' => 'lookbook_url',   'label' => 'Lookbook / portfolio URL', 'type' => 'url'],
                ['key' => 'shop_url',       'label' => 'Shop my picks URL',  'type' => 'url'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),
            'fashion_beauty.salon' => array_merge($base, [
                ['key' => 'address',        'label' => 'Street address',     'type' => 'text', 'required' => true],
                ['key' => 'phone',          'label' => 'Phone number',       'type' => 'phone'],
                ['key' => 'hours',          'label' => 'Opening hours',      'type' => 'textarea'],
                ['key' => 'booking_url',    'label' => 'Book online URL',    'type' => 'url'],
                ['key' => 'service_1',      'label' => 'Service #1',         'type' => 'text'],
                ['key' => 'service_1_desc', 'label' => 'Service #1 price/desc', 'type' => 'text'],
                ['key' => 'service_2',      'label' => 'Service #2',         'type' => 'text'],
                ['key' => 'service_2_desc', 'label' => 'Service #2 price/desc', 'type' => 'text'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'review_url',     'label' => 'Reviews URL',        'type' => 'url'],
            ]),

            // ── Photo / Video ───────────────────────────────────────────
            'photographer.photographer' => array_merge($base, [
                ['key' => 'specialty',      'label' => 'Specialty (1 line)', 'type' => 'text', 'placeholder' => 'Portrait & product photography'],
                ['key' => 'portfolio_url',  'label' => 'Portfolio URL',      'type' => 'url'],
                ['key' => 'gallery_url',    'label' => 'Client galleries / proofs URL', 'type' => 'url'],
                ['key' => 'booking_url',    'label' => 'Book a shoot URL',   'type' => 'url'],
                ['key' => 'price_blurb',    'label' => 'Starting from',      'type' => 'text', 'placeholder' => 'Sessions from $200'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'behance',        'label' => 'Behance URL',        'type' => 'url'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),
            'photographer.videographer' => array_merge($base, [
                ['key' => 'specialty',      'label' => 'Specialty (1 line)', 'type' => 'text', 'placeholder' => 'Brand films & music videos'],
                ['key' => 'showreel_url',   'label' => 'Showreel URL',       'type' => 'url'],
                ['key' => 'portfolio_url',  'label' => 'Portfolio URL',      'type' => 'url'],
                ['key' => 'booking_url',    'label' => 'Book a shoot URL',   'type' => 'url'],
                ['key' => 'price_blurb',    'label' => 'Starting from',      'type' => 'text'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'youtube',        'label' => 'YouTube channel URL','type' => 'url'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),
            'photographer.wedding_photographer' => array_merge($base, [
                ['key' => 'portfolio_url',  'label' => 'Portfolio / galleries URL', 'type' => 'url'],
                ['key' => 'package_1',      'label' => 'Package #1 name',    'type' => 'text', 'placeholder' => 'Half-day'],
                ['key' => 'package_1_price','label' => 'Package #1 price',   'type' => 'text'],
                ['key' => 'package_2',      'label' => 'Package #2 name',    'type' => 'text', 'placeholder' => 'Full-day'],
                ['key' => 'package_2_price','label' => 'Package #2 price',   'type' => 'text'],
                ['key' => 'booking_url',    'label' => 'Check your date URL','type' => 'url'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),
            'photographer.studio' => array_merge($base, [
                ...
                ['key' => 'service_2',      'label' => 'Service #2',         'type' => 'text'],
                ['key' => 'service_2_desc', 'label' => 'Service #2 price/desc', 'type' => 'text'],
                ['key' => 'booking_url',    'label' => 'Book the studio URL','type' => 'url'],
                ['key' => 'phone',          'label' => 'Phone number',       'type' => 'phone'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),

            // ── Travel Creator ──────────────────────────────────────────
            'travel_creator.travel_blogger' => array_merge($base, [
                ['key' => 'blog_url',       'label' => 'Blog / website URL', 'type' => 'url'],
                ['key' => 'youtube',        'label' => 'YouTube channel URL','type' => 'url'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'tiktok',         'label' => 'TikTok username',    'type' => 'text'],
                ['key' => 'featured_url',   'label' => 'Featured link (latest post/video)', 'type' => 'url'],
                ['key' => 'featured_label', 'label' => 'Featured link label','type' => 'text', 'placeholder' => '✈ My latest adventure'],
                ['key' => 'gear_url',       'label' => 'Travel gear / shop URL', 'type' => 'url'],
                ['key' => 'newsletter_blurb','label' => 'Newsletter pitch',  'type' => 'text'],
                ['key' => 'collab_email',   'label' => 'Collaboration email','type' => 'email'],
            ]),
            'travel_creator.travel_agent' => array_merge($base, [
                ['key' => 'specialty',      'label' => 'Specialty (1 line)', 'type' => 'text', 'placeholder' => 'Luxury honeymoons & safaris'],
                ['key' => 'booking_url',    'label' => 'Plan a trip / consult URL', 'type' => 'url'],
                ['key' => 'trip_1',         'label' => 'Featured trip #1',   'type' => 'text'],
                ['key' => 'trip_1_price',   'label' => 'Trip #1 price',      'type' => 'text', 'placeholder' => 'from $2,400'],
                ['key' => 'trip_2',         'label' => 'Featured trip #2',   'type' => 'text'],
                ['key' => 'trip_2_price',   'label' => 'Trip #2 price',      'type' => 'text'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'phone',          'label' => 'Phone number',       'type' => 'phone'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),
            'travel_creator.tour_guide' => array_merge($base, [
                ['key' => 'location',       'label' => 'City / region',      'type' => 'text', 'placeholder' => 'Kyoto, Japan'],
                ['key' => 'tours_url',      'label' => 'Book a tour URL',    'type' => 'url'],
                ['key' => 'price_blurb',    'label' => 'Starting price',     'type' => 'text', 'placeholder' => 'Tours from $45'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'whatsapp',       'label' => 'WhatsApp number',    'type' => 'phone'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),
            'travel_creator.digital_nomad' => array_merge($base, [
                ['key' => 'current_location','label' => 'Currently in',      'type' => 'text', 'placeholder' => 'Lisbon, Portugal'],
                ['key' => 'blog_url',       'label' => 'Blog / website URL', 'type' => 'url'],
                ['key' => 'youtube',        'label' => 'YouTube channel URL','type' => 'url'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'twitter',        'label' => 'X / Twitter handle', 'type' => 'text'],
                ['key' => 'gear_url',       'label' => 'Gear / resources URL', 'type' => 'url'],
                ['key' => 'newsletter_blurb','label' => 'Newsletter pitch',  'type' => 'text'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),

            // ── Community / Faith ───────────────────────────────────────
            'faith.church' => array_merge($base, [
                ['key' => 'denomination',   'label' => 'Denomination / tradition', 'type' => 'text', 'placeholder' => 'Non-denominational'],
                ['key' => 'address',        'label' => 'Address',            'type' => 'text'],
                ['key' => 'service_times',  'label' => 'Service times',      'type' => 'textarea', 'placeholder' => "Sun 9am & 11am\nWed 7pm"],
                ['key' => 'give_url',       'label' => 'Give / donate URL',  'type' => 'url'],
                ['key' => 'events_url',     'label' => 'Events / calendar URL', 'type' => 'url'],
                ['key' => 'livestream_url', 'label' => 'Watch live URL',     'type' => 'url'],
                ['key' => 'phone',          'label' => 'Phone number',       'type' => 'phone'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),
            'faith.faith_leader' => array_merge($base, [
                ['key' => 'role',           'label' => 'Role',               'type' => 'text', 'placeholder' => 'Pastor, Imam, Rabbi…'],
                ['key' => 'sermons_url',    'label' => 'Sermons / talks URL','type' => 'url'],
                ['key' => 'book_url',       'label' => 'Book / writings URL','type' => 'url'],
                ['key' => 'give_url',       'label' => 'Give / donate URL',  'type' => 'url'],
                ['key' => 'instagram',      'label' => 'Instagram',          'type' => 'text'],
                ['key' => 'youtube',        'label' => 'YouTube channel URL','type' => 'url'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),
            'faith.community_group' => array_merge($base, [
                ['key' => 'focus',          'label' => 'What the group is about', 'type' => 'text'],
                ['key' => 'meeting_info',   'label' => 'When & where we meet','type' => 'textarea'],
                ['key' => 'join_url',       'label' => 'Join / RSVP URL',    'type' => 'url'],
                ['key' => 'events_url',     'label' => 'Events / calendar URL', 'type' => 'url'],
                ['key' => 'whatsapp',       'label' => 'WhatsApp number',    'type' => 'phone'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),
            'faith.mosque_temple' => array_merge($base, [
                ['key' => 'tradition',      'label' => 'Tradition',          'type' => 'text'],
                ['key' => 'address',        'label' => 'Address',            'type' => 'text'],
                ['key' => 'service_times',  'label' => 'Prayer / service times', 'type' => 'textarea'],
                ['key' => 'give_url',       'label' => 'Donate URL',         'type' => 'url'],
                ['key' => 'events_url',     'label' => 'Events / calendar URL', 'type' => 'url'],
                ['key' => 'phone',          'label' => 'Phone number',       'type' => 'phone'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),
            ...
            // ── Education / School ──────────────────────────────────────
            'education.tutor' => array_merge($base, [
                ['key' => 'subjects',       'label' => 'Subjects',           'type' => 'text', 'placeholder' => 'Math, Physics — GCSE & A-Level'],
                ['key' => 'levels',         'label' => 'Levels / age groups','type' => 'text'],
                ['key' => 'mode',           'label' => 'In-person, online or both?', 'type' => 'select', 'options' => [['v'=>'online','l'=>'Online'], ['v'=>'in_person','l'=>'In-person'], ['v'=>'both','l'=>'Both']]],
                ['key' => 'price',          'label' => 'Hourly rate',        'type' => 'text', 'placeholder' => '£40 / hour'],
            ...
            'education.school' => array_merge($base, [
                ['key' => 'tagline',        'label' => 'Tagline (1 line)',   'type' => 'text'],
                ['key' => 'address',        'label' => 'Address',            'type' => 'text'],
                ['key' => 'admissions_url', 'label' => 'Admissions / apply URL', 'type' => 'url'],
                ['key' => 'programs_url',   'label' => 'Programs / courses URL', 'type' => 'url'],
                ['key' => 'events_url',     'label' => 'Events / open day URL', 'type' => 'url'],
                ['key' => 'phone',          'label' => 'Phone number',       'type' => 'phone'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),
            'education.online_course' => array_merge($base, [
                ['key' => 'tagline',        'label' => 'One-line pitch',     'type' => 'text', 'required' => true, 'placeholder' => 'Master X in 30 days'],
                ['key' => 'enroll_url',     'label' => 'Enrol URL',          'type' => 'url',  'required' => true],
                ['key' => 'price',          'label' => 'Price',              'type' => 'text', 'placeholder' => '$129 · early bird $99'],
                ['key' => 'curriculum',     'label' => 'What you\'ll learn (one per line)', 'type' => 'textarea'],
                ['key' => 'preview_url',    'label' => 'Free preview / lesson URL', 'type' => 'url'],
                ['key' => 'newsletter_blurb','label' => 'Newsletter pitch',  'type' => 'text'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email'],
            ]),
            'education.teacher' => array_merge($base, [
                ['key' => 'subject',        'label' => 'Subject / department', 'type' => 'text'],
                ['key' => 'school',         'label' => 'School / University', 'type' => 'text'],
                ['key' => 'resources_url',  'label' => 'Class resources URL','type' => 'url'],
                ['key' => 'syllabus_url',   'label' => 'Syllabus URL',       'type' => 'url'],
                ['key' => 'office_hours',   'label' => 'Office hours',       'type' => 'text', 'placeholder' => 'Tue & Thu 2–4pm'],
                ['key' => 'email',          'label' => 'Contact email',      'type' => 'email', 'required' => true],
            ]),
        ];
