    ...
    public function buildDigest(User $creator, bool $isSample = false): ?array
    {
        ...
        return [
            ...
            'viewData' => [
                ...
                'profileUrl'          => \App\Modules\Common\Support\PlatformHosts::outboundUrl(url('/@' . $creator->handle)),
                'statsUrl'            => \App\Modules\Common\Support\PlatformHosts::outboundUrl(url('/user/creator-stats')),
