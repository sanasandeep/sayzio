...
class BlockDefaults
{
    ...
    public static function styleForType(string $type): array
    {
        ...
        $hardcoded = match ($canonical) {
            ...
            'one_time_offer', 'paypal', 'buy_me_coffee', 'patreon', 'ko_fi', 'tip_jar',
    ...
    public static function contentForType(string $type): array
    {
        ...
        $hardcoded = match ($type) {
            ...
            'tip_jar' => ['title' => 'Send me a tip', 'message' => 'Your support means the world. Every tip goes directly to me with 0% platform fee.', 'amounts' => [3, 5, 10, 25], 'allow_custom' => true, 'button_text' => 'Send Tip', '_placeholder' => true],
