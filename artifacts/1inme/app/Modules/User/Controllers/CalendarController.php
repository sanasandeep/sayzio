...
class CalendarController extends Controller
{
    ...
    private function exportCalendarIcs($events, string $filename, string $userTz, string $calName): \Symfony\Component\HttpFoundation\StreamedResponse
    {
    ...
    private function exportCalendarCsv($events, string $filename, string $userTz): \Symfony\Component\HttpFoundation\StreamedResponse
    {
