...
class PlanManagementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user.plans.index')->with('success', 'Plan created successfully.');
    }
    ...
    public function update(Request $request, Plan $plan)
    {
        ...
        return redirect()->route('user.plans.index')->with('success', 'Plan updated successfully.');
    }
    ...
    public function destroy(Plan $plan)
    {
        ...
        $plan->delete();
        return redirect()->route('user.plans.index')->with('success', 'Plan deleted.');
    }
