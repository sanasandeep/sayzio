...
class PlanFormCatalogue
{
    ...
    public static function modules(): array
    {
        return [
            ...
            'module_store_menu'   => ['label' => 'Store Menu Pages',      'desc' => 'Store / product catalog link pages with order-request carts.'],
            'module_service_booking' => ['label' => 'Service Booking Pages', 'desc' => 'Service booking / appointment-request link pages.'],
            ...
            'module_text'         => ['label' => 'Text Pages',           'desc' => 'Paste-text link pages with selectable text and a copy button.'],
    ...
    public static function quantityLimits(): array
    {
        return [
            ...
            ['key' => 'max_store_menu',       'label' => 'Max store menu pages',    'default' => 1,   'module' => 'module_store_menu',  'hint' => 'How many store / product catalog link pages a user can publish.'],
            ['key' => 'max_service_booking',  'label' => 'Max service booking pages','default' => 1,  'module' => 'module_service_booking', 'hint' => 'How many service booking / appointment-request link pages a user can publish.'],
            ['key' => 'max_service_booking_staff', 'label' => 'Max staff per booking page', 'default' => 1, 'module' => 'module_service_booking', 'hint' => 'How many staff / team members each service booking page can list. 0 = staff feature hidden; -1 = unlimited.'],
            ...
            ['key' => 'max_text_pages',       'label' => 'Max text pages',          'default' => 1,   'module' => 'module_text',        'hint' => 'How many Text Pages (paste text → shareable page with a copy button) a user can publish. -1 = unlimited.'],
            ...
            ['key' => 'max_qr_codes',         'label' => 'Max saved QR codes',      'default' => -1,  'module' => 'module_short_links', 'hint' => 'How many QR codes a user can keep saved in the QR Studio library. -1 = unlimited (default, no change for existing plans).'],
            ['key' => 'max_qr_art_monthly',   'label' => 'AI QR art generations / month', 'default' => -1, 'module' => 'module_ai_suite', 'hint' => 'Monthly allowance of successful AI Artistic QR generations (coin charges still apply). Failed/refunded generations don\'t count. -1 = unlimited (default).'],
            ...
            ['key' => 'max_browser_sync_items', 'label' => 'Max browser sync items / type', 'default' => -1, 'module' => null, 'hint' => 'Zio Browser cloud-sync rows a user can store per data type (bookmarks, collections, history, reading list). -1 = unlimited (still hard-capped server-side).'],
            ...
            ['key' => 'max_marketing_plans',  'label' => 'Max saved marketing plans', 'default' => 0, 'module' => null,                 'hint' => 'How many named plans a user can keep in the Marketing Plan Calculator. 0 = none can be saved; -1 = unlimited. Requires the calculator toggle to be on.'],
    ...
    public static function featureFlags(): array
    {
        return [
            ...
            ['key' => 'service_booking_calendar_sync', 'type' => 'bool', 'module' => 'module_service_booking'],
            ...
            ['key' => 'marketing_plan_calculator', 'type' => 'bool', 'module' => null],
            ...
            ['key' => 'connected_apps',       'type' => 'bool',   'module' => null],
            ...
            ['key' => 'browser_sync',         'type' => 'bool',   'module' => null],
    ...
    private static function localCopy(): array
    {
        return [
            ...
            'connected_apps'        => ['name' => 'Connected apps',        'description' => 'Connect CRMs (Salesforce, HubSpot, Zoho) and Google Analytics for two-way lead/contact sync and server-side event forwarding.'],
    ...
    public static function moduleKeys(): array
    {
        return [
            ...
            'module_store_menu'   => ['max_store_menu'],
            'module_service_booking' => ['max_service_booking', 'max_service_booking_staff', 'service_booking_calendar_sync'],
