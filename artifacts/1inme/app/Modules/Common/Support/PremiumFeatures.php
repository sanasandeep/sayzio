...
class PremiumFeatures
{
    ...
    public static function catalogue(): array
    {
        return [
            // ---- Limits ----
            ['key' => 'max_links', 'group' => 'Limits', 'name' => 'Short links', 'description' => 'How many short links and Link in Bio pages you can create across all of your projects.', 'unit' => 'links'],
            ...
            ['key' => 'max_minds', 'group' => 'AI suite', 'name' => 'Knowledge Bases', 'description' => 'Labelled knowledge bases your AI agents and coach can draw on — add text, FAQs, documents, links or live Sayzio data.', 'unit' => 'knowledge bases'],
            ['key' => 'max_personas', 'group' => 'AI suite', 'name' => 'AI Agents', 'description' => 'Configurable AI agents that combine a system prompt, tone and the Knowledge Bases you choose.', 'unit' => 'agents'],
