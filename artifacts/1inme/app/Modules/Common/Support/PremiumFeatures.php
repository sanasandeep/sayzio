...
class PremiumFeatures
{
    ...
    public static function catalogue(): array
    {
        return [
            ...
            ['key' => 'marketing_plan_calculator', 'group' => 'Tools & extras', 'name' => 'Marketing Plan Calculator', 'description' => 'Build a 12-month channel plan, live projections dashboard and ROI summary from your own budget and assumptions — no spreadsheet needed.'],
            ['key' => 'max_marketing_plans', 'group' => 'Tools & extras', 'name' => 'Saved marketing plans', 'description' => 'How many named plans you can keep saved in the Marketing Plan Calculator.', 'unit' => 'plans'],
