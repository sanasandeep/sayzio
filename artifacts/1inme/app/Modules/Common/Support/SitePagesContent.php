...
class SitePagesContent
{
    ...
    public static function policyDefaultsV2(): array
    {
        ...
        return [
            'terms' => [
                'title' => 'Terms of Service',
                'meta_description' => 'The terms governing your use of {{app_name}} — your account, what you can publish, billing, intellectual property, governing law and how the relationship can end.',
    ...
    public static function policyDefaults(): array
    {
        ...
        return [
            ...
            'refunds' => [
                'title' => 'Refunds Policy',
                'meta_description' => 'How refunds work for {{app_name}} paid plans and add-ons — eligibility, timing, coin wallet, taxes and fees, statutory rights, exceptions and how to request one.',
