...
Route::prefix('user')->name('user.')->group(function () {
    ...
    Route::middleware(['auth', 'workspace.scope', 'workspace.2fa', \App\Modules\User\Middleware\EnsureFeatureAvailable::class])->group(function () {
        ...
        Route::prefix('ai')->name('ai.')->group(function () {
            ...
            Route::post  ('marketing-strategist/profile',                    [\App\Modules\User\Controllers\AI\MarketingStrategistController::class, 'saveProfile'])->name('marketing-strategist.profile.save');
