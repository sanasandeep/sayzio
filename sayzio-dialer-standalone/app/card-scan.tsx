...
export default function CardScanScreen() {
  ...
  async function takePhoto() {
    ...
    if (!perm.granted) {
      showAlert(
        "Camera unavailable",
        "Allow camera access to photograph a card, or pick an image from your gallery instead.",
      );
      return;
    }
      ...
      >
        <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <Text style={[styles.hint, { color: colors.mutedForeground }]}>
            Snap or pick up to 6 images: front and back of a visiting card, or
            brochure pages. The AI extracts the person's details for you.
          </Text>
        ...
        <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <Text style={[styles.hint, { color: colors.mutedForeground }]}>
            Tell the AI what to prioritise, e.g. "just the name and phone
            number". Leave blank to extract everything.
          </Text>
          <TextInput
            value={instruction}
            onChangeText={(t) =>
            ...
            placeholder="e.g. only grab the name and phone number"
          ...
          <>
            <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
              <View style={styles.resultHeader}>
                ...
                <Text style={[styles.sectionLabel, { color: colors.foreground, marginBottom: 0, marginLeft: 6 }]}>
                  Extraction complete
                </Text>
              </View>
